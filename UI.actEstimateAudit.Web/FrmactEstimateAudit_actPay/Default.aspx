<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UI.actEstimateAudit.Web.FrmactEstimateAudit_actPay.Default" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" MyName="gvList" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="會簽編號" Visible="True">
                                    <ItemTemplate>
                                      <%--  <asp:Label ID="lblacmWordNum" runat="server" Text='<%# Eval("acmWordNum") +"<br/>"+ Eval("acmTopWordNum") %>'></asp:Label>--%>


                                         <asp:Label ID="Label1" runat="server" Text='<%# Eval("acmWordNum") %>'></asp:Label>
                                    </ItemTemplate>
                             ...
                             <%--   <asp:TemplateField HeaderText="核定明細號" Visible="True">
                                ...
                                <asp:TemplateField HeaderText="報支號" Visible="True">
                                    <ItemTemplate>
                                        <asp:Label ID="lblacpPayNoPrv" runat="server" Text='<%# Eval("acpPayNo") %>'></asp:Label>
                                    </ItemTemplate>
                           ...
                           <%--     <asp:TemplateField HeaderText="分項計畫" Visible="True">
                               ...
                               <%-- <asp:TemplateField HeaderText="用途別" Visible="True">
                                ...
                                <asp:TemplateField HeaderText="事由(用途說明)" Visible="True">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="動支金額" Visible="True">
                                    <ItemTemplate>
