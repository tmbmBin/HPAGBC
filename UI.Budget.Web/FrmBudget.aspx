...
<body>
    <form id="form1" runat="server">
   	<table cellSpacing="0" cellPadding="0" border="0">
				<tr>
					<td vAlign="top">
						<table style="MARGIN-TOP: 10px; MARGIN-LEFT: 10px; BORDER-COLLAPSE: collapse; width:600px" borderColor="#666668"
												...
												<table style="WIDTH: 600px; HEIGHT: 184px" cellSpacing="0" cellPadding="5" border="0">
													...
													<tr>
                                                      ...
                                                      <%--  <td align="right" width="100">承辦業務別</td>
                                                       ...
                                                       <td align="right" width="100" style="display:none">承辦業務別</td>
														<td style="display:none"><asp:dropdownlist id="DDLBiz" runat="server"></asp:dropdownlist></td>
													</tr>
													<tr>
													...
													<tr>
                                                        <td colspan="2">
                                                                <table style="table-layout:fixed; width:100%; border:0">
                                                                    <tr>
                                                                        <td align="right" width="80">凍結數：</td>
                                                                        <td >
                                                                            <asp:TextBox ID="ctl_bgtFreezeMoney" runat="server" Width="87px"></asp:TextBox>
                                                                        </td>
                                                                        <td align="right" width="80">節約數：</td>
                                                                        <td >
                                                                            <asp:TextBox ID="ctl_SavingMoney" runat="server" Width="87px"></asp:TextBox>
                                                                        </td>
                                                                        <td align="right" width="130">預計刪減數：</td>
                                                                        <td >
                                                                            <asp:TextBox ID="ctl_bgtCutMoney" runat="server" Width="87px"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
