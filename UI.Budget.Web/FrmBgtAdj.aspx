		...
		var dblTmpMoney;
			for (var i=0;i<document.forms[0].elements.length;i++)
			{
				...
				if (bolFlag== 0)
				{
					...
					if (e.getAttribute("MyName") == "TBdgMoney" && e.getAttribute("MyIndex") == parObj.getAttribute("MyParentIndex"))
					{
					bolFlag=1;
					}
				}
				...
				if (e.getAttribute("MyParentIndex") == parObj.getAttribute("MyParentIndex") && e.getAttribute("MyName") == "TBMonthMoney")
				{
				    try {
				        dblTmpMoney = parseFloat(replaceString(e.value, ",", ""));
				        if (isNaN(dblTmpMoney) == true) { dblTmpMoney = 0; }
				    }
				    catch (e)
				    { dblTmpMoney = 0; }
				    dblTotal += parseFloat(replaceString(dblTmpMoney, ",", ""));
				}
