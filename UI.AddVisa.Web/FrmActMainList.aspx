                                    ...
                                    <table border="0" width="100%" cellpadding="1" style="border-collapse: collapse">
                                        <tr>
                                            ...
                                            <td align="left" class="auto-style3">
                                                <asp:DropDownList ID="DDLBgtSource" runat="server"></asp:DropDownList></td>
                                        </tr>
                                        <tr>
                                            <td align="right" style="width: 80px">經費單位</td>
                                            <td align="left" style="width: 200px">
                                                <asp:DropDownList ID="DDLBgtDep" runat="server"></asp:DropDownList></td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" style="width: 200px">
                                                <asp:DropDownList ID="DDLWorkUnit" runat="server"></asp:DropDownList></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TBAcmWordNum" runat="server" Width="115px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="TBMoney" runat="server" Width="116px" onkeypress="return check_Num()"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="TBacvMoney" runat="server" Width="116px" onkeypress="return check_Num()"></asp:TextBox></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                ...
                <tr>
                    <td bordercolor="#666668" style="border-right: #666668 1pt solid; border-top: #666668 1pt solid; border-left: #666668 1pt solid; border-bottom: #666668 1pt solid">
                        <table border="1" cellpadding="1" style="border-collapse: collapse" bordercolor="#ffffff" width="100%">
                            <tr>
                                <td>
                                    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" EnableModelValidation="True" GridLines="Vertical" Width="100%" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="GridView1_RowDataBound" OnRowCreated="GridView1_RowCreated">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="編輯">
                                                <ItemTemplate>
                                                    <%--<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/UI.ActProdApply.Web/FrmActApply.aspx?MenuID=1321&WorkStatus=Copy&acmYear=" + Eval("acmYear") + "&acmNo="+ Eval("acmNo") + "&acmTopWordNum=" +  Eval("acmWordNum")   %>'>瀏覽</asp:HyperLink>--%>
                                                    <asp:LinkButton ID="BtnView" Text="瀏覽" runat="server" OnClientClick="alert('本筆資料無經費單位的管理權限，故無法異動。');"></asp:LinkButton>
                                                    <asp:HyperLink ID="HLView" runat="server" NavigateUrl='<%# "../UI.Comm.Web/FrmActDataProxy.aspx?WorkStatus=Copy&acmYear=" + Eval("acmYear") + "&acmNo="+ Eval("acmNo") + "&acmTopWordNum=" +  Eval("acmWordNum")   %>'>瀏覽</asp:HyperLink>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="年度" SortExpression="acmYear">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="HFdgAcmNo" runat="server" Value='<%# Eval("acmNo") %>' />
