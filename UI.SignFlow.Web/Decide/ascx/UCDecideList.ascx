<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCDecideList.ascx.cs" Inherits="UI.SignFlow.Web.Decide.ascx.UCDecideList" %>
...
<a class="status-view" href="#" title='<%# Eval("FormPK") %>'>開啟</a>
</ItemTemplate>
</asp:TemplateField>
</Columns>
<AlternatingRowStyle CssClass="zebra" />
<EmptyDataRowStyle CssClass="empty" />
<EmptyDataTemplate>尚無任何已決行案件。</EmptyDataTemplate>
</asp:GridView>
