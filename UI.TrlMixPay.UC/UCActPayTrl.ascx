...
<script src="../UI.TrlMixPay.UC/ScriptFiles/UCActPayTrlMix.js" type="text/javascript"></script>
            ...
            <table cellpadding="0" style="border-collapse: collapse; width: 100%" border="1"
                    ...
                    <td height="20" class="sFoldTitle">
                        <table cellpadding="0" style="border-collapse: collapse" border="0">
                            <tr>
                                ...
                                <td width="99%" class="sFoldTitleFont" onclick="show_item('FoldTitle_11')">出差人員資料<font color="red" size="2pt">←請展開</font>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr id="FoldTitle_11" style="display: block" onpropertychange="sync_title_img(this)">
                    <td style="padding: 5px">
                        <table style="" border="0" cellpadding="1" cellspacing="1" width="635px">
                            <tr>
                                <td colspan="6">
                                    <asp:Button ID="btnSelect" MyName="btnSelect" Style="vertical-align: middle" runat="server" Text="選取員工資料..." OnClick="btnSelect_Click" />
                                    <input id="hdfReturn" myname="hdfReturn" type="hidden" runat="server" />
                                    <input id="hdfusrAlias" myname="hdfusrAlias" type="hidden" runat="server" />
                                </td>
                            </tr>
                            <tr>
                                <td width="90px" align="right">所屬單位：
                                </td>
                                <td width="125px">
                                    <asp:TextBox ID="ctl_AcpTrlDepName" runat="server"
                                        Width="120px" Enabled="True" DBFieldName="acpTrlDepName"></asp:TextBox>
                                </td>
                                <td width="90px" align="right">姓名：
                                </td>
                                <td width="125px">
                                    <asp:TextBox ID="ctl_AcpTrlEmpName" runat="server"
                                        Width="120px" Enabled="True" DBFieldName="acpTrlEmpName"></asp:TextBox>
                                </td>
                                <td width="90px" align="right">員工編號：
                                </td>
                                <td width="85px">
                            ...
                            <tr>
                                <td width="90px" align="right">職等：
                                </td>
                                <td>
                                    <asp:TextBox ID="ctl_AcpTrlRankLevelName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.acpTrlRankLevelName") %>'
                                        Width="120px" Enabled="True" DBFieldName="acpTrlRankLevelName"></asp:TextBox>
                                </td>
                                <td width="90px" align="right">職別：
                                </td>
                                <td>
                            ...
                            <tr style="display: none">
                                <td width="90px" align="right">出差天數：
                                </td>
                                <td>
                                    <asp:TextBox ID="ctl_AcpTrlDateCount" onfocus="this.select()" Style="text-align: Right"
                                        ...
                                        Width="120px" Enabled="True" DBFieldName="acpTrlDateCount"></asp:TextBox>
                                </td>
                                <td width="90px" align="right">單據張數：
                                </td>
                                <td>
                            ...
                            <tr style="display: black">
                                <td width="90px" align="right">起訖日期：
                                </td>
                                <td colspan="5">
                            ...
                            <tr style="display: none">
                                ...
                                <td>&nbsp;</td>
                                <td width="90px" align="right">差旅金額：
                                </td>
                                <td>
                            ...
                            <tr style="display: none">
                                <td width="90px" align="right">部門代碼：
                                </td>
                                <td>
