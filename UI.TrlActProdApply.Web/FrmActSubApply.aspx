<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmActSubApply.aspx.vb" Inherits="UI.TrlActProdApply.Web.FrmActSubApply" %>
...
<head runat="server">
    ...
    <script language="javascript" src="../ScriptFiles/ShowBgtWeb/ShowBudget1.js" type="text/javascript"></script>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fnCallSearchDialog() {
            ...
            if (strReturnVal != "Cancel") { document.all("TBFindSql").value = strReturnVal; }
        ...
        //2015 10/23 調整
        $(function () {
            $("#<%= CBDocFlag.ClientID%> ").attr("checked", true); //自動勾選 簽文
            displayForTrl2(); //上方chk隱藏
        });


            //#region  上方check隱藏 for 國外差旅
            function displayForTrl2() {
                $('#Trl2_display_1').hide(); //零用金 .那一行
                //$('#Trl2_display_2').hide(); //承辦人分機
                //$('#Trl2_display_3').hide();//附 件
            }
            //#endregion
...
<!--
    ...
    function ShowProdData() {
        ...
        if (document.all("CBDocFlag").checked == true) {
            try { document.all("TRProdData").style.display = "none"; } catch (e) { }
            try { document.all("TRProdData1").style.display = "none"; } catch (e) { }


        }
        else {
            try { document.all("TRProdData").style.display = "block"; } catch (e) { }
            try { document.all("TRProdData1").style.display = "block"; } catch (e) { }
    ...
    function ShowTmpPayData() {
        ...
        if (document.all("CBAutoTempPay").checked == true) {
            try { document.all("TRTmpPayData").style.display = "block"; } catch (e) { }
            try { document.all("TRTmpPayData1").style.display = "block"; } catch (e) { }


        }
        else {
            try { document.all("TRTmpPayData").style.display = "none"; } catch (e) { }
            try { document.all("TRTmpPayData1").style.display = "none"; } catch (e) { }
