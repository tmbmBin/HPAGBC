				...
				<tr>
					<td style="BORDER-RIGHT: #666668 1pt solid; BORDER-TOP: #666668 1pt solid; BORDER-LEFT: #666668 1pt solid; BORDER-BOTTOM: #666668 1pt solid"
						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#ffffff" cellPadding="1" width="100%"
								...
								<td>
									<table style="TABLE-LAYOUT: fixed" cellPadding="1" width="100%" border="0">
										<tr>
											...
											<td vAlign="bottom" align="left"><asp:textbox id="TBTranBatchNum" runat="server" 
							...
							<tr>
								<td><asp:DropDownList id="DDLAcmYear" runat="server" Width="100px"></asp:DropDownList>
								...
								<td vAlign="bottom" align="left">
									<table cellPadding="1" border="0">
										<tr>
											...
											<td vAlign="bottom" align="center"><input type="button" id="BtnPrint1" 
											...
											<td vAlign="bottom" align="center"><asp:button id="BtnImport" runat="server" 
