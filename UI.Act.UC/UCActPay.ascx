<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCActPay.ascx.vb" Inherits="UI.Act.UC.UCActPay" %>
        ...
        <td style="padding: 0px">
            <table cellpadding="2" cellspacing="0" style="table-layout: fixed" border="0">
                <tr style="display: none">
                    ...
                    <td width="80" align="right">&nbsp;</td>
                    <td width="130">
                        <asp:TextBox ID="TBPayYear" runat="server" Width="39px"></asp:TextBox></td>
                    <td width="80" align="right">&nbsp;</td>
                    <td width="120">&nbsp;</td>
                </tr>
                <tr>
                    <td align="right">
                        <asp:Label ID="LBDate" runat="server" Text="報支日期"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="TBAcpMarkDate" runat="server" MyName="TBAcpMarkDate" Style="background-color: #FFFFE0; text-align: center" Width="90px" ondblclick="JavaScript: UCPDate.Show();" Enabled="False"></asp:TextBox></td>
                    <td align="right">報支金額</td>
                    <td>
                        <asp:TextBox ID="TBPayMoney" runat="server" MyName="TBPayMoney" Style="text-align: right" BackColor="Transparent" Width="90px" onfocus="this.blur();" onkeypress="return check_Num()"></asp:TextBox></td>
                    <td align="right">
                        <asp:Label ID="LBPayNo" runat="server" Text="報支次號"></asp:Label></td>
                    <td>
                        <asp:DropDownList ID="DDLPayNo" runat="server" Width="90px" AutoPostBack="True" MyName="DDLPayNo"></asp:DropDownList></td>
                </tr>
                <tr>
                    ...
                    <td style="display: none" align="right">借款人</td>
                    <td style="display: none">
                        <asp:TextBox ID="TBAcpPrePayName" runat="server" MaxLength="20"
                ...
                <tr>
                    ...
                    <td width="500" colspan="5">
                        <asp:TextBox ID="TBPayName" runat="server" Width="490px" Enabled="False" MyName="TBPayName" ondblclick="fnCallPhraseFun('TBPayName');"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="100" style="display: none">
                        <asp:TextBox ID="TBAcpPrePayDate" runat="server" Width="90px" MyName="TBAcpPrePayDate" ondblclick="JavaScript: UCPrePayDate.Show();"></asp:TextBox></td>
                    ...
                    <td width="100">
                        <asp:TextBox ID="TBAcpReturnDate" runat="server" Width="90px" MyName="TBAcpReturnDate" ondblclick="JavaScript: UCReturnDate.Show();" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr style="display: none">
                    ...
                    <td width="100" align="right" style="display: none">電支付號</td>
                    <td width="100" style="display: none">
