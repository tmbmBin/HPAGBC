	...
	<tr>
		...
		<table cellpadding="2" cellspacing="0"  style="TABLE-LAYOUT: fixed" border="0">
			<tr style="display:none">
				...
				<td width="100">&nbsp;</td>
				<td width="80" align="right">電支付號</td>
				<td width="130">
                    <asp:TextBox ID="TBAcpEtcPayWordNum" runat="server" MaxLength="20" 
                        Width="23px" Enabled="False"></asp:TextBox>
                </td>
				<td width="80" align="right"><asp:TextBox ID="TBPayYear" runat="server" Width="39px"></asp:TextBox></td>
				<td width="120">&nbsp;</td>
			</tr>
			<tr>
