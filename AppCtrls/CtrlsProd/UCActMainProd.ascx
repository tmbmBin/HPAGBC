<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCActMainProd.ascx.vb" Inherits="AppCtrls.UCActMainProd" %>
...
<table _ondblclick="alert('11:UCActMainProd.ascx')" cellpadding="0" style="border-collapse: collapse; margin-top: -1; width: 100%" border="0">
	<tr>
		<td>
		<!-- ↓折疊項目(11) -->
			...
			<tr>
				...
				<table cellpadding="0" style="border-collapse: collapse" border="0">
					<tr>
						...
						<td width="99%" class="sFoldTitleFont" onclick="show_item('FoldTitle_11')">請購內容<font color="red" size="2pt">←請展開</font></td>
					</tr>
				</table>
				</td>
			</tr>
