<%@ Page MaintainScrollPositionOnPostback="true" EnableEventValidation="false" Language="vb" AutoEventWireup="false" CodeBehind="FrmTsbOther.aspx.vb" Inherits="UI.Case.Web.FrmTsbOther" %>
                                                                ...
                                                                <td align="right">
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="right" style="padding-left: 5px; display: none" nowrap>
                                                                                <asp:CheckBox ID="CBSecrearyFlag" runat="server" Font-Size="X-Small" TextAlign="Left" Visible="False" Text="秘書室審核" /></td>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding-right: 5px; display: none" nowrap>
                                                                                <asp:CheckBox ID="CBEPayment" runat="server" Font-Size="X-Small" TextAlign="Right" Text="電子支付" Visible="True" Style="display: none" /></td>
                                                                            <td style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBDocFlag" runat="server" Font-Size="X-Small" TextAlign="Right" Text="簽文" Visible="True" Style="display: none" />
                                                                            </td>
                                                                            <td></td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <td style="text-align: right">
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding-right: 5px" nowrap>&nbsp;</td>
                                                                            <td style="padding-right: 5px; display: none" nowrap>
                                                                                <asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行暫付" Style="display: none" Visible="True" onclick="showfiled(this);chkTmpPayAndCash();" />
...
<%--   沒用到暫時拿掉，不然會有空白。 in 2015/09/10           
        <td width="5"></td>
                <td style="background: #e6e6fa; width: 200px; vertical-align: top;">
