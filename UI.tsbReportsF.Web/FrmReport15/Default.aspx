            ...
            <asp:Panel ID="pnlSearch" runat="server" class="MainCon3">
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td class="qury_table_td2">
                            <asp:TextBox ID="txtDateStart" runat="server" Width="130px" MyKendoDatePicker="MyKendoDatePicker" onfocus="blur()"></asp:TextBox>
                            <asp:Label ID="lblMonth" runat="server" Text="至" Height="25"></asp:Label>
                            <asp:TextBox ID="txtDateEnd" runat="server" Width="130px" MyKendoDatePicker="MyKendoDatePicker" onfocus="blur()"></asp:TextBox>
