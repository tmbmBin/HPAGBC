<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UI.tsbReportsF.Web.FrmReport05.Default" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="pnlSearch" runat="server" class="MainCon3">
                <h1 class="h1Class">應付未付費用估列明細表</h1>
                <table style="width: 100%;">
                    <tr>
                        <td class="qury_table_td">報表區分</td>
                        <td class="qury_table_td3">
                            <asp:DropDownList ID="ddltsbEstimateType" runat="server" AppendDataBoundItems="True">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
