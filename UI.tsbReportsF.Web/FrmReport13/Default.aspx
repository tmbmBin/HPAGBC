<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UI.tsbReportsF.Web.FrmReport13.Default" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="pnlSearch" runat="server" class="MainCon3">
                <h1 class="h1Class">應付費用估列明細表</h1>
                <table style="width: 100%;">
                    <tr>
                        <td class="qury_table_td">期間區分</td>
