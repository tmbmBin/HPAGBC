	...
	Sub Page_Load(Sender As Object, E As EventArgs)
		If Not IsPostBack Then '第一次
            If Request("account") <> "" Then '由其他程序導入
                ...
                If Login(DB.sysMenu.DAT.sysMenuDT.ChkPwdType.DoCheck, Check) = False Then '登入不成功
                    Response.End()
                End If
...
<body onload="document.all('text_account').focus();">
	<form runat="server">
		<div id="oDiv" style="background-color: #FFFFFF; position: absolute; left:expression(document.body.clientWidth/2-oDiv.offsetWidth/2); top:expression(document.body.clientHeight/2-oDiv.offsetHeight/2)">
					...
					<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" height="30">
							<tr>
								...
								<td align="right"><img style="margin-top: 0" border="0" src="images/title_item_left.gif"></td>
								...
								<td><img style="margin-top: 0" border="0" src="images/title_item_right.gif"></td>
								<td>&nbsp;</td>
							</tr>
						</table>
						</td>
				...
				<table style="margin-top: -4; border-collapse: collapse" borderColor="#f8f8fa" cellSpacing="0" cellPadding="5" bgColor="#dadee9" border="1" Width="100%">
					<tr>
						...
						<table cellSpacing="0" cellPadding="5" border="0">
							<tr>
								<td noWrap align="right" width="80">帳號</td>
								<td ><asp:TextBox id="text_account" runat="server" width="150">99999</asp:TextBox></td>
								<td align="right" width="20">　</td>
							</tr>
							<tr Style="display: block">
								<td align="right" width="80">密碼</td>
								<td ><asp:TextBox id="text_password" runat="server" TextMode="Password" width="150" AutoComplete="off"></asp:TextBox></td>
								<td align="right" width="20">　</td>
							</tr>
						</table>
						</td>
