<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Memo.aspx.cs" Inherits="tsbficSubisdyParaT.Web.FrmtsbficSubisdyParaT_tsbficSubisdyPara.Memo" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="ODS_tsbMemo" runat="server" TypeName="ShareTable.DAO.tsbMemoDAO" OldValuesParameterFormatString="original_{0}" SelectMethod="getList" SelectCountMethod="getListCount">
            <SelectParameters>
                ...
                <asp:Parameter Name="tsbType" Type="String" DefaultValue="2" />  <%--(1.委辦 2.補捐助)--%>
            </SelectParameters>
