<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmActProdFlowSubApply.aspx.vb" Inherits="UI.ActProdApply.Web.FrmActProdFlowSubApply" %>
...
<head runat="server">
    ...
    <script language="javascript" src="../ScriptFiles/ShowBgtWeb/ShowBudget1.js" type="text/javascript" />
...
<script language="javascript" type="text/javascript">
    ...
    function fnCallSearchDialog() {
        ...
        if (strReturnVal != "Cancel") { getObjByID("TBFindSql").value = strReturnVal; }
...
<!--
    ...
    function ShowProdData() {
        ...
        if (getObjByID("CBDocFlag").checked == true) {
            try { getObjByID("TRProdData").style.display = "none"; } catch (e) { }
            try { getObjByID("TRProdData1").style.display = "none"; } catch (e) { }
        }
        else {
            try { getObjByID("TRProdData").style.display = "block"; } catch (e) { }
            try { getObjByID("TRProdData1").style.display = "block"; } catch (e) { }
        }
        ...
        if (CheckMod == "9") {
            ...
            try { getObjByID("TDAcmMoney1").style.display = "none"; } catch (e) { }
            try { getObjByID("TDAcmMoney2").style.display = "block"; } catch (e) { }
        }
        else {
            try { getObjByID("TDAcmMoney1").style.display = "none"; } catch (e) { }
            try { getObjByID("TDAcmMoney2").style.display = "block"; } catch (e) { }
        ...
        if (selectedIndex > -1) {
            ...
            if (selectedValue != "請修單") {
                for (var i = 0; i < document.forms[0].elements.length; i++) {
                    ...
                    if (e.getAttribute("MyName") == "TBAcmMoney2") {
                        objTarget = e;
                    }
                ...
                $(document).on("keyup", "[MyName='TBExtraTotal']", function () {
                    $("[MyName='TBAcmMoney2']").val(NumToFStr($(this).val()));
                });
...
<%--20151022 [Edit]:加入附加檔案功能需修改 head 位置--%>
<%--</head>--%>
<body topmargin="5" leftmargin="10" rightmargin="0" bottommargin="50" onload='get_cookies();ShowTmpPayData();ShowProdData();' onunload='set_cookies()'>
    <form id="form1" runat="server">
        <table id="TablePass" runat="server" style="margin-top: 0px; margin-left: 10px; border-collapse: collapse; display: none" cellpadding="5" width="600" bgcolor="#dadee9">
            <tr>
            ...
            <tr>
                <td style="border-right: #666668 1pt solid; border-top: #666668 1pt solid; border-left: #666668 1pt solid; border-bottom: #666668 1pt solid" bordercolor="#666668" width="700" valign="top" align="left">
                    <table style="border-collapse: collapse" bordercolor="#ffffff" cellpadding="1" width="100%" border="1">
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    <td align="right" style="padding-left: 5px" nowrap>
                                                        <asp:CheckBox ID="CBAcmUnitPassFlag" runat="server" Font-Size="X-Small" TextAlign="Left" Text="單位審核" /></td>
                                                    <td align="right" style="padding-left: 5px" nowrap>
                                    ...
                                    <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <%--    <td style="padding-right: 5px" nowrap>
                                                        <asp:CheckBox ID="CBDocFlag" runat="server"
                                                            Font-Size="X-Small" TextAlign="Right" Text="簽文" onclick="ShowProdData(this);" /></td>--%>
                                                    <td style="padding-right: 5px; display: none" nowrap>
                                                        <asp:CheckBox ID="CBDocFlag" runat="server"
                                                            Font-Size="X-Small" TextAlign="Right" Text="簽文" onclick="ShowProdData(this);" /></td>
                                                    <%--20151015 [add]:增加表單名稱下拉式選單--%>
                                                    <td style="padding-right: 5px" nowrap>
                                                        <asp:DropDownList ID="DDLAcmFormName" runat="server" AutoPostBack="true" Width="100px" Visible="true" Style="background-color: #FFFFE0">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td style="text-align: right">
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    <td style="padding-right: 5px; display: none" nowrap>
                                                        <asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行暫付" Visible="True" onclick="ShowTmpPayData(this);" /></td>
                                                    <td style="padding-right: 5px" nowrap>
                                                        <asp:CheckBox ID="CBAutoBid" runat="server" Font-Size="X-Small" TextAlign="Right" Text="自動決標" Visible="True" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                            ...
                            <td>
                                <table border="0" cellpadding="1" cellspacing="1" width="100%" style="table-layout: fixed">
                                    <tr>
                                        ...
                                        <td style="width: 110px">
                                            <asp:TextBox ID="TBAcmWordNum" runat="server" Width="100px"
                                                BackColor="Transparent" onfocus="this.blur();"></asp:TextBox>
                                            <asp:TextBox ID="TBWordSubNum" runat="server" Width="15px"
                                        ...
                                        <td style="width: 120px">
                                            <asp:TextBox ID="TBAcmMarkDate" runat="server" Width="113px" onfocus="this.blur();" Style="text-align: center" BackColor="Transparent"></asp:TextBox></td>
                                        <td align="right" style="width: 85px">動支金額</td>
                                        <td>
                                            <asp:TextBox ID="TBAcmMoney" runat="server" Width="113px" BackColor="Transparent" onfocus="this.blur();" Style="text-align: right" MyName="TBAcmMoney"></asp:TextBox></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr style="display: none">
                            <td>
                                <asp:TextBox ID="txtFormNameForSubApply" runat="server"></asp:TextBox><!--UC傳值用-->
                            </td>
                        </tr>
                    </table>
                </td>
                <td valign="top" width="200" bgcolor="#ffffff" rowspan="3">
                    <iframe id="iFrame" border="0" name="iFrame" frameborder="0" width="200" scrolling="no" height="500"></iframe>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="border-right: #666668 1pt solid; border-top: #666668 1pt solid; border-left: #666668 1pt solid; border-bottom: #666668 1pt solid" bordercolor="#666668">
                    <table style="table-layout: fixed; border-collapse: collapse" bordercolor="#ffffff" cellpadding="5" width="100%" border="1">
                            ...
                            <td valign="bottom" align="left">
                                <table cellpadding="1" border="0">
                                    <tr>
                                        ...
                                        <td valign="bottom" align="center" style="<%=strHideFlowUIFlag %>">
                                        ...
                                        <td valign="bottom" align="center">
                                         ...
                                         <%--20151119 [mdf]:增加簽核送出按鈕--%>
                                        <td>
                                            <asp:Button ID="BtnSend" runat="server" Text="送出"  Height="22px" Visible="false"></asp:Button></td>
                                        <%--20151029 [mdf]:增加簽核作業隱藏期標--%>
                                        <td valign="bottom" align="center" style="<%=strHideFlowUIFlag %>">
                                            <asp:Button ID="BtnSearch" runat="server" Text="查詢" Height="22"></asp:Button></td>
                                        <%--20150825 [mdf]:顯示 列印 按鈕--%>
                                        <%--	<td valign="bottom" align="center">
                                    <input type="button" id="BtnPrint1" runat="server" 
                                        style="width: 40px; height: 22px" value="列印"  visible="False" /><asp:button id="BtnPrint" runat="server" Text="列印" Height="22" Visible=false ></asp:button></td>--%>
                                        <td valign="bottom" align="center">
                                            <input type="button" id="BtnPrint1" runat="server"
                                                style="width: 40px; height: 22px" value="列印" visible="True" /><asp:Button ID="BtnPrint" runat="server" Text="列印" Height="22" Visible="false"></asp:Button></td>
                            ...
                            <td style="<%=strHideFlowUIFlag %>">
                                <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True" PageSize="5">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="TotalSubApplyMoney" HeaderText="再簽金額" DataFormatString="{0:#,#}" SortExpression="TotalSubApplyMoney">
                                            <HeaderStyle Width="70px"></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                        </asp:BoundColumn>
                        ...
                        <tr>
                            <%--20151029 [mdf]:增加簽核作業隱藏期標--%>
                            <td align="right" style="<%=strHideFlowUIFlag %>">
                                <table style="border-collapse: collapse" cellpadding="0" border="0">
                                    <tr>
                                        <td style="width: 200px; font-size: 10pt">共
