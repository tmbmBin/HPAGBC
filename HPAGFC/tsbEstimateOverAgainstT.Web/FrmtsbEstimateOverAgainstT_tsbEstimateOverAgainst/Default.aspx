<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="tsbEstimateOverAgainstT.Web.FrmtsbEstimateOverAgainstT_tsbEstimateOverAgainst.Default" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel ID="pnlSearch" runat="server" class="MainCon3">
                <h1 class="h1Class">估列高估沖銷資料查詢</h1>
                <table style="width: 100%">
                    <tr>
                        <td class="qury_table_td">日期區間</td>
                        <td class="qury_table_td2" colspan="3">&nbsp;&nbsp;至&nbsp;&nbsp;
                            <asp:TextBox ID="txttsbEstimateDate" runat="server" Width="200px" MyKendoDatePicker="MyKendoDatePicker" onclick="blur()"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="MainCon2">
                <h1 class="h1Class">估列高估沖銷資料明細</h1>
                ...
                <div>
                    <asp:GridView ID="GridView1" runat="server" MyName="gvList" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="估列高估沖銷總額" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lbltsbEstiOverAgainstMoney" runat="server"></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Width="100" />
                                <ItemStyle HorizontalAlign="Center" Width="100" />
                            </asp:TemplateField>
