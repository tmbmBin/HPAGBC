<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCActPayVisa.ascx.vb" Inherits="UI.Act.UC.UCActPayVisa" %>
	...
	<tr>
		...
		<table cellpadding="0" style="border-collapse: collapse; width: 100%" border="1" bordercolor="#FFFFFF">
			...
			<tr id="FoldTitle_14" style="display: block" onpropertychange="sync_title_img(this)">
							...
							<asp:datagrid id="DataGrid2" runat="server" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="經費單位" >
										<HeaderStyle Width="110px" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="X-Small" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" ></HeaderStyle>
										<ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
										<ItemTemplate>
											<asp:DropDownList id="DDLdgBgtDepCode" runat="server" Width="110" Style="background-color: #FFFFE0" MyName="DDLdgBgtDepCode" MyIndex='<%# Container.ItemIndex %>' AutoPostBack="true" >
												<asp:ListItem Value=""></asp:ListItem>
											</asp:DropDownList>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderText="承辦業務">
										<HeaderStyle Width="110px" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="X-Small" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" ></HeaderStyle>
										<ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
										<ItemTemplate>
											<asp:DropDownList id="DDLdgBiz" runat="server" Width="110" Style="background-color: #FFFFE0" MyName="DDLdgBiz" MyIndex='<%# Container.ItemIndex %>' AutoPostBack="True" >
												<asp:ListItem Value=""></asp:ListItem>
											</asp:DropDownList>
										</ItemTemplate>
									</asp:TemplateColumn>
									...
									<asp:TemplateColumn HeaderText="暫付" Visible="false">
									...
									<asp:TemplateColumn HeaderText="就地審計" Visible="false">
				...
				<table cellpadding="3" style="border-collapse: collapse; margin-bottom: -2px; width: 100%; display:none" border="0">
					<tr>
						<td>
