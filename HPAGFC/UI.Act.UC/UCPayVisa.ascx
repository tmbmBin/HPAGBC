<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCPayVisa.ascx.vb" Inherits="UI.Act.UC.UCPayVisa" %>
                                                                ...
                                                                <td align="left" style="width: 100%">
                                                                    <table style="margin-left: 0px; table-layout: fixed" border="0" cellpadding="0" cellspacing="0">
                                                                        <tr style="width: 100%">
                                                                            ...
                                                                            <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 0px; color: #ffffff; text-align: center; display: none;">承辦業務</td>
                                                                            <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 180px; color: #ffffff; text-align: center">計畫科目</td>
                                                                            ...
                                                                            <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 0px; color: #ffffff; text-align: center; display: none">用途說明</td>
                                                                            <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 0px; color: #ffffff; text-align: center; display: none">暫付</td>
                                                                            <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 90px; color: #ffffff; text-align: center; ">就地審計</td>
                                                                            <td style="font-size: 10pt; width: 60px; color: #ffffff; text-align: center" align="center">新增移除</td>
                                                                            <%--  1030912 格式亂掉修改 Start  --%>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                        ...
                                                        <table style="margin-left: 0px; table-layout: fixed; width: 900px" border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td align="left" style="width: 97%">
                                                                    <table style="width: 100%; margin-left: 0px; table-layout: fixed" border="0" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td style="border-right: #ffffff 1px solid; width: 30px; text-align: center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                            ...
                                                                            <td style="border-right: #ffffff 1px solid; width: 180px;">
                                                                            ...
                                                                            <td style="width: 90px;" >
                                                                                <%--20160812 就地審計--%>
                                                                                <asp:TextBox ID="TBdgInspectName" runat="server" Width="88px" onfocus="this.blur();" 
                                                                                    MyIndex="<%# Container.ItemIndex %>" MyName="TBdgInspectName" Enabled="false"></asp:TextBox>
                                                                                <asp:HiddenField ID="TBdgInspect" runat="server" />
                                                                            </td>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <table style="margin-left: 0px; table-layout: fixed" border="0" cellpadding="0" cellspacing="0">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td style="border-right: #ffffff 1px solid; text-align: center; width: 66px;">
                                                                                                    <%--門別--%>
                                                                                                ...
                                                                                                <td style="border-right: #ffffff 1px solid; text-align: center; width: 110px;">
                                                                                                    <%--經費單位--%>
                                                                                                ...
                                                                                                <td style="border-right: #ffffff 1px solid; display: none; text-align: center; width:80px;" >
                                                                                                ...
                                                                                                <td style="border-right: #ffffff 1px solid; text-align: center; width: 180px;">
                                                                                                    <%--計畫科目--%>
                                                                                                ...
                                                                                                <td style="border-right: #ffffff 1px solid; text-align: center; width: 150px;">
                                                                                                   <%--用途別科目--%>
                                                                                                ...
                                                                                                <td style="border-right: #ffffff 1px solid; text-align: center; width: 0px; display: none">
                                                                                                    <asp:TextBox ID="TBdlAcvMemo" runat="server" Width="98%" Style="background-color: #FFFFE0"></asp:TextBox></td>
                                                                                                <td style="border-right: #ffffff 1px solid; text-align: center; width: 0px; display: none; background-color: #FFFFE0">
                                                                                                    <asp:CheckBox ID="CBdlPrePayFlag" runat="server" /></td>
                                                                                                <%--20160812 開啟就地審計，增加DropDownList--%>
                                                                                                <td style="border-right: #ffffff 1px solid; text-align: center; width: 90px;  background-color: #FFFFE0">
                                                                                                    <asp:DropDownList ID="DDLdlInspect" runat="server" Style="background-color: #FFFFE0; width:88px;" MyName="DDLdlInspect"></asp:DropDownList>
                                                                                                </td>
                                                                                                <td style="border-right: #ffffff 1px solid; width: 60px; background-color: #FFFFE0">
