...
<head runat="server">
    ...
    <script language="javascript" src="ScriptFiles/FrmTrlPrePay.js" type="text/javascript"></script>
...
//    //strParams = "&acmyear=" + <%=Session("default_Year") %> + "&acmNo=" + document.all("TBAcmWordNum").title + "&acmwordnum=" + document.all("TBAcmWordNum").value + "&acmNo1=0" + "&acpPayYear=" +  <%=Session("default_Year") %>  + "&acmkidnum=<%=strDefKidNum  %>" + "&page1qty=7&page2qty=43" ;
        ...
        //20151222 [add]:核支日期需要呼叫的javascript
...
<body topmargin="5" leftmargin="10" rightmargin="0" bottommargin="50" onload='get_cookies();ShowTmpPayData();ShowProdData(this);' onunload='set_cookies()'>
    ...
    <form id="form1" runat="server">
        <!-- ↓審核原因 -->
           <%--20151222 [mdf]:顯示核支日期--%>
        <%--<table id="TablePass" runat="server" style="display: none; margin-top: 0px; margin-left: 0px; border-collapse: collapse;" cellpadding="5" width="600" bgcolor="#dadee9">--%>
                                ...
                                <table cellpadding="0" style="border-collapse: collapse" border="1" bordercolor="#666668" bgcolor="#DADEE9">
                                    <tr>
                                        <td style="padding-top: 1px" onpropertychange="try{childNodes.width = this.clientWidth;}catch(e){;};">
                                            ...
                                            <!-- ↓審核 -->
                                            <table cellpadding="0" border-collapse: collapse; margin-top: -1; width: 600px" border="1" bordercolor="#FFFFFF">
                                                <tr>
                                                                            ...
                                                                            <td style="text-align: right">
                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="padding-right: 5px;" nowrap>
                                                                                            <asp:CheckBox ID="CBAutoShouldPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="應付" Visible="True" Enabled="False" /></td>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    <td style="display: 1none">
                                                        <input type="button" id="BtnPrint1" runat="server" style="width: 50px; height: 22px" value="列印" /></td>
        ...
        <%-- 20151222 [add]:核支日期需要使用的元件--%>
        <ComponentArt:Calendar ID="UCPassDate" runat="server" CalendarCssClass="calendar" CalendarTitleCssClass="title" ClientSideOnSelectionChanged="UCPassDate_Change" CultureId="1028" DayCssClass="day" DayHeaderCssClass="dayheader" DayHoverCssClass="dayhover" MonthCssClass="month" NextImageUrl="../images/cal_nextMonth.gif" OtherMonthDayCssClass="othermonthday" PickerFormat="Long" PopUp="Custom" PopUpExpandControlId="TBAcpPassDate" PrevImageUrl="../images/cal_prevMonth.gif" SelectedDayCssClass="selectedday"></ComponentArt:Calendar>
