...
<body>
    <form id="form1" runat="server">
        ...
        <div style="text-align: center; margin: 10px;">
            <asp:Button ID="btnSearch" runat="server" Text="開始過濾" CssClass="Btn08" OnClientClick="startBlockUI()" OnClick="btnSearch_Click" />
            &nbsp;&nbsp;
            ...
            <asp:GridView ID="GridView1" runat="server" MyName="gvList" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="會簽編號" Visible="True">
                        <ItemTemplate>
                            <asp:Label ID="lbltsbApplyWordNum" runat="server" Text='<%# Eval("tsbApplyWordNum") %>' ToolTip='<%# Eval("tsbYear")+"-"+Eval("tsbApplyNo") %>'></asp:Label>
