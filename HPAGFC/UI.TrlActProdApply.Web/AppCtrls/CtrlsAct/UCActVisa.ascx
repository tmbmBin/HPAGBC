<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCActVisa.ascx.vb" Inherits="UI.TrlActProdApply.Web.UCActVisa" %>
						...
						<div id="div_UCActVisa" class="DIV1_width" alt="DIV1" style="BEHAVIOR: url(<%= resolveurl(scrollposurl)%>)" persistid="<%= savescrollpos.uniqueid %>" scrollpos="<%= savescrollpos.value %>"><input type="hidden" id="savescrollpos" name="savescrollpos" runat="server" />
							<asp:datagrid id="DataGrid2" runat="server" Width="100%" 
								...
								<Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="控帳業務">
										<HeaderStyle Width="90px" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="X-Small" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" CssClass="hidden" ></HeaderStyle>
										<ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" CssClass="hidden"></ItemStyle>
										<ItemTemplate>
											<asp:DropDownList id="DDLdgBiz" runat="server" Width="90" Style="background-color: #FFFFE0" MyName="DDLdgBiz" MyIndex='<%# Container.ItemIndex %>' AutoPostBack="False" >
												<asp:ListItem Value=""></asp:ListItem>
											</asp:DropDownList>
									...
									<asp:TemplateColumn HeaderText="就地審計">
										...
										<ItemStyle HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
										<ItemTemplate>
                                            <asp:DropDownList ID="DDLdgInspect"   runat="server"  Width="110px" MyName="DDLdgInspect" ></asp:DropDownList>
										    <asp:CheckBox id="CBdginspect" runat="server"  MyName="CBdginspect" MyIndex='<%# Container.ItemIndex %>' Visible="false" ></asp:CheckBox>
										</ItemTemplate>
									</asp:TemplateColumn>
