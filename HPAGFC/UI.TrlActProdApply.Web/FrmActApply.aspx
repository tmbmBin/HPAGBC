<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmActApply.aspx.vb" Inherits="UI.TrlActProdApply.Web.FrmActApply" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ShowProdData() {
        if (document.all("CBDocFlag").checked == true || document.all("CBAcmActKind").checked == true) {
            try { document.all("TRTmpProdData").style.display = "none"; } catch (e) { }
            try { document.all("TRTmpProdData1").style.display = "none"; } catch (e) { }
        }
        else {
            try { document.all("TRTmpProdData").style.display = "block"; } catch (e) { }
            try { document.all("TRTmpProdData1").style.display = "block"; } catch (e) { }
            try { document.all("DDLAcmFormName").disabled = false; } catch (e) { }
        }
    ...
    function ShowAddVisaData(parSObj, parTObj) {
        if (document.all("CBAddVisa").checked == true) {
            try { document.all("TDAddVisaData1").style.display = "block"; } catch (e) { }
            try { document.all("TDAddVisaData2").style.display = "block"; } catch (e) { }

        }
        else {
            try { document.all("TDAddVisaData1").style.display = "none"; } catch (e) { }
            try { document.all("TDAddVisaData2").style.display = "none"; } catch (e) { }
