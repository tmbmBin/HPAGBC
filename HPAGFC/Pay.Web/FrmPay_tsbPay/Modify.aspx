    ...
    <form id="form1" runat="server">
            ...
            <table style="width: 100%;" border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!---經資門--->
                        <asp:DropDownList ID="ddlEcodBgtOrigin" runat="server" onfocus="this.blur()" Width="100%"></asp:DropDownList>
                        <!---預算來源--->
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlEcodDepartName" runat="server" onfocus="blur()" Width="100%"></asp:DropDownList>
                        <!---經費單位--->
                        <asp:DropDownList ID="ddlcodBiz" runat="server" onfocus="blur()" Width="100%" Style="display: none"></asp:DropDownList><!---控帳業務---->
                    ...
                    <td style="width: 7%">
                        <asp:TextBox ID="txtEselectEstimateData" runat="server" onfocus="blur()" Style="display: none"></asp:TextBox><!--回傳的估列字串--->
                        <asp:TextBox ID="txtESTotaltsbEstimateMoney" runat="server" onfocus="blur()" Width="97%"></asp:TextBox>
                    </td>
                    <td style="width: 2%">
                        <input id="btnEselectEstimate" type="button" value="..." /></td>
                    <!--選擇要沖抵的估列btn--->
                    <td style="width: 7%">
                    ...
                    <td style="width: 7%">
                        <asp:TextBox ID="txtselectPrepayData" runat="server" onfocus="blur()" Style="display: none" Width="98%"></asp:TextBox>
                        <!--回傳的預撥字串--->
                    ...
                    <td style="text-align: center">
                        ...
                        <asp:TextBox ID="txtEtsbtemp" runat="server" Width="98%" Style="display: none"></asp:TextBox>
                        <!--暫存用(目前沒用到但開啟隱藏可以用)--->
						<asp:TextBox ID="txtEtsbGroupNo" runat="server" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}" Width="96%"  Style="display: none"></asp:TextBox>
						  <!--公務才有用(基金隱藏)--->
                    </td>
                </tr>
            </table>
            ...
            <asp:GridView ID="GridView1" runat="server" MyName="gvList" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="受款人名稱" Visible="True">
                        <ItemTemplate>
                            <asp:Label ID="lblStsbPayeeName" runat="server" Text='<%# Eval("StsbPayeeName") %>' ToolTip='<%# Eval("StsbPayeeNo") %>'></asp:Label>
                    ...
                    <asp:TemplateField HeaderText="沖抵估列" Visible="True">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="費用" Visible="True">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="沖抵預撥金額" Visible="True">
                        <ItemTemplate>
                            ...
                            <!---確認金額用-->
                            <asp:Label ID="lblStsbPreMoney" runat="server" Text='<%#  string.Format("{0:N0}", Eval("StsbPreMoney  ")) %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" Width="70" Font-Size="14px" />
                        <ItemStyle HorizontalAlign="Center" Width="70" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="付現" Visible="True">
                        <ItemTemplate>
                            <asp:Label ID="lblSTotaltsbCash" runat="server" Text='<%#   string.Format("{0:N0}", Eval("StsbCash")) %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" Width="70" Font-Size="14px" />
                        <ItemStyle HorizontalAlign="Center" Width="70" />
                    </asp:TemplateField>
					   ...
					   <asp:TemplateField HeaderText="群組編號" Visible="false">
                        <ItemTemplate>
        ...
        <script type="text/javascript">
            ...
            $(function () {
				...
				//	if (STotaltsbPayMoney == "NaN" ) 
                //        alert("尚未輸入核銷金額")
                //    else {
                //
                //        var txtESTotaltsbPayMoney = $("#<%= txtESTotaltsbPayMoney.ClientID %>").val().replace(",", ""); //移除千分位
                //        var tmptsbFee = parseInt(txtESTotaltsbPayMoney, 10) - parseInt($("#txtESTotaltsbEstimateMoney").val().replace(",", ""), 10);
                //        if (tmptsbFee == "NaN") {
                ...
                //        alert("尚未輸入核銷金額")
                //    else {
                //        var txtESTotaltsbPayMoney = $("#<%= txtESTotaltsbPayMoney.ClientID %>").val().replace(",", "");
                //        var tmptsbCash = parseInt(txtESTotaltsbPayMoney, 10) - parseInt($("#txtESTotaltsbPreMoney").val().replace(",", ""), 10);
                //
                ...
                $("#txtESTotaltsbEstimateMoney").bind("change", function () {
                    var STotaltsbPayMoney = parseFloat($("#txtESTotaltsbPayMoney").val(), 10);
                    if (STotaltsbPayMoney == "NaN")
                    {
                        alert("尚未輸入核銷金額")
                    }
                    else {
                        var txtESTotaltsbPayMoney = $("#<%= txtESTotaltsbPayMoney.ClientID %>").val().replace(/[,]+/g,""); //移除千分位
                        var tmptsbFee = parseFloat(txtESTotaltsbPayMoney, 10) - parseFloat($("#txtESTotaltsbEstimateMoney").val().replace(/[,]+/g,""), 10);
                        if (tmptsbFee == "NaN") {
                            tmptsbFee = txtESTotaltsbPayMoney
                        }
                        $("#<%= txtESTotaltsbFee.ClientID %>").val(tmptsbFee.toString().replace("NaN", txtESTotaltsbPayMoney)); //費用金額
                ...
                $("#txtESTotaltsbPreMoney").bind("change", function () {
                    ...
                    if (STotaltsbPayMoney == "NaN") {
                        ...
                        var tmptsbCash = parseFloat(txtESTotaltsbPayMoney, 10) - parseFloat($("#txtESTotaltsbPreMoney").val().replace(/[,]+/g, ""), 10);
                        $("#<%= txtESTotaltsbCash.ClientID %>").val(tmptsbCash.toString().replace("NaN", txtESTotaltsbPayMoney)); //付現金額
                    }
                });
            ...
            //判斷是空值或NULL
            function checkNullEmpty(tmpobject) {

                if (tmpobject !== null && tmpobject !== undefined && tmpobject !== '')
                    return true;
                else
                    return false;
            ...
            $("#btnSave").click(function () {
                if ($("#form1").valid()) {
                    ...
                    //檢查電子支付號
                    var tmpValue = $("input[id^='<% =this.FormView1.FindControl("RdbCPayKind").ClientID %>']:checked").val()
                    if (tmpValue == '2' && $("#<% =this.FormView1.FindControl("txtCtsbEtcPayWordNum").ClientID %>").val() == '') {
                        alert("請檢查是否已輸入電子支付號！！");
                        return false;
                    }
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (tmptsbOutlayCode.length > 0)
                            ...
                            $('#ddloulOutlayCode option[value=' + result.tsbDecideDtlDTO.tsbOutlayCode + ']').attr('selected', true); // 預設值
