<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showExchNo.aspx.cs" Inherits="Pay.Web.FrmPay_tsbPay.showExchNo" %>
                ...
                <div>
                    ...
                    <asp:GridView ID="GridView1" runat="server" MyName="gvList" AutoGenerateColumns="False"
                        ...
                        <Columns>
                         ...
                         <%--   <asp:TemplateField HeaderText="會簽號" Visible="True">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="核銷號" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblStsbPayNo" runat="server" Text='<%# Eval("StsbPayNo") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Width="60" />
                                <ItemStyle HorizontalAlign="Center" Width="60" />
                            </asp:TemplateField>--%>
                           ...
                           <%-- <asp:TemplateField HeaderText="欲撥年度" Visible="True">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="預撥日期" Visible="True">
                                <ItemTemplate>
                       ...
                       <%--      <asp:TemplateField HeaderText="明細號" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblSFK_DetailNo1" runat="server" Text='<%# Eval("SFK_DetailNo1") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Width="60" />
                                <ItemStyle HorizontalAlign="Center" Width="60" />
                            </asp:TemplateField>--%>
                             ...
                             <asp:TemplateField HeaderText="傳票號碼" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblStsbExchNo1" runat="server" Text='<%# Eval("StsbExchNo1") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Width="60" />
                                <ItemStyle HorizontalAlign="Center" Width="60" />
                            </asp:TemplateField>
                             ...
                             <asp:TemplateField HeaderText="沖抵金額" Visible="True">
                                <ItemTemplate>
