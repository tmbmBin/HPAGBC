				...
				<tr>
					<td valign="top">
						<table style="WIDTH: 598px; BORDER-COLLAPSE: collapse" borderColor="#f8f8fa" cellSpacing="0"
							...
							<tr>
								<td valign="top">
									<TABLE style="table-layout:fixed; border-collapse:collapse" borderColor="#f8f8fa" cellSpacing="0" cellPadding="1" width="100%" border="0">
										<TR>
										...
										<TR>
											...
											<TD style="WIDTH: 120px" align="right"><FONT style="FONT-SIZE: 12pt" face="新細明體">登錄權限</FONT></TD>
