                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            <td align="right" style="padding-left: 5px; display: block" nowrap>
                                                                                <asp:CheckBox ID="CBAcmUnitPassFlag" runat="server" Font-Size="Small" TextAlign="Left" Visible="True" Text="單位審核" /></td>
                                                                            <td align="right" style="padding-left: 5px; display: none" nowrap>
                                                                                <asp:CheckBox ID="CBSecrearyFlag" runat="server" Font-Size="Small" TextAlign="Left" Text="秘書室審核" /></td>
                                                                            <td align="right" style="padding-left: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBAccPassFlag" runat="server" Font-Size="Small" TextAlign="Left" Text="主計審核" class="MainPassName" /></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            <td style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBAllowanceFlag" runat="server" Font-Size="Small" TextAlign="Right" Text="零用金" Visible="True" /></td>
                                                                            <td style="padding-right: 5px" nowrap class="NotVisible">
                                                                                <asp:CheckBox ID="CBSeparateFlag" runat="server" Font-Size="Small" TextAlign="Right" Text="分期付款" Visible="True" /></td>
                                                                            <td style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBEPayment" runat="server" Font-Size="Small" TextAlign="Right" Text="電子支付" Visible="True" /></td>
                                                                            <td style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBDocFlag" runat="server" Font-Size="Small" TextAlign="Right" Text="免列印請購單" Visible="True" /></td>
                                                                            <td style="padding-right: 5px" nowrap class="NotVisible">
                                                                                <asp:CheckBox ID="CBacpDirectPay" runat="server" Font-Size="Small" TextAlign="Right" Text="直接核銷" Visible="True" /></td>
                                                                            <td></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding-right: 5px; display: none" nowrap>
                                                                                <asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="Small" TextAlign="Right" Text="逕行暫付" Visible="True" onclick="showfiled(this);chkTmpPayAndCash();" /><asp:CheckBox ID="CBAddVisa" runat="server" Font-Size="Small" TextAlign="Right" Text="加簽" Visible="True" onclick="ShowAddVisaData(this);" /></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
