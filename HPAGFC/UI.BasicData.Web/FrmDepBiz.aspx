<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmDepBiz.aspx.vb" Inherits="UI.BasicData.Web.FrmDepBiz"%>
<%@ Register TagPrefix="ComponentArt" Namespace="ComponentArt.Web.UI" Assembly="ComponentArt.Web.UI" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmDepBiz</title>
										...
										<tr>
											<td><asp:datagrid id="DataGrid1" runat="server" Width="100%" Height="72px" AllowPaging="True" CellPadding="3"
													...
													<Columns>
														...
														<asp:BoundColumn DataField="BizName" HeaderText="承辦業務別"></asp:BoundColumn>
														<asp:BoundColumn DataField="dpzCreateDate" HeaderText="生效日期"></asp:BoundColumn>
														<asp:BoundColumn DataField="dpzStopFlag" HeaderText="停用否"></asp:BoundColumn>
														<asp:BoundColumn DataField="dpzStopDate" HeaderText="停用日期"></asp:BoundColumn>
														<asp:BoundColumn DataField="dpzDepCode" HeaderText="部門代碼" Visible="False"></asp:BoundColumn>
														<asp:BoundColumn DataField="dpzBizCode" HeaderText="承辦業務別代碼" Visible="False"></asp:BoundColumn>
														<asp:BoundColumn DataField="codCodeVer" HeaderText="科目年度別" Visible="False"></asp:BoundColumn>
													</Columns>
