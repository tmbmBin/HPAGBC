                                ...
                                <td>
                                    <table style="table-layout: fixed; width: 100%">
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <tm:MyTextBox ID="ctl_acmDateB" runat="server" WhereText="DS.acmDate" WhereOperator="大於等於" DBFieldDataType="DateTime" Width="80px"></tm:MyTextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <tm:MyDropDownList ID="ctl_acmWorkUnitNo" runat="server" WhereText="IsNull(IsNull(M1.acmWorkUnitNo, M.acmWorkUnitNo), '')" WhereOperator="等於" Width="150px"></tm:MyDropDownList></td>
                                            <td style="width: 100px; text-align: right">經費單位：</td>
                                            <td>
                                                <tm:MyDropDownList ID="ctl_acvBgtDepCode" runat="server" WhereText="acvBgtDepCode" WhereOperator="等於" Width="150px"></tm:MyDropDownList></td>
                                            <td style="width: 100px; text-align: right">經資門別：</td>
                                            <td>
                                                <tm:MyDropDownList ID="ctl_acvAccKind" runat="server" WhereText="acvAccKind" WhereOperator="等於" Width="150px"></tm:MyDropDownList></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 100px; text-align: right">預算來源：</td>
                                            <td>
                                                <tm:MyDropDownList ID="ctl_acvBgtSourCode" runat="server" WhereText="acvBgtSourceCode" WhereOperator="等於" Width="150px"></tm:MyDropDownList></td>
                                            ...
                                            <td>
                                                <tm:MyTextBox ID="ctl_acpPayName" runat="server" WhereText="acpPayName" WhereOperator="關鍵字" Width="140px"></tm:MyTextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 100px; text-align: right">傳票狀態：</td>
                                            <td>
                                                <tm:MyDropDownList ID="ctl_AcvExchStatus" runat="server" Width="150px">
                                            ...
                                            <td>
                                                <tm:MyTextBox ID="ctl_AcvExchNo" runat="server" Width="140px"></tm:MyTextBox></td>
                                            <td style="width: 100px; text-align: right">群組編號：</td>
                                            <td>
                                                <tm:MyTextBox ID="ctl_acpGroupNo" runat="server" WhereText="acpGroupNo" WhereOperator="等於" Width="140px"></tm:MyTextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 100px; text-align: right">計畫科目：</td>
                                            <td colspan="3">
                                                <tm:MyDropDownList ID="ctl_acvPlanCode" runat="server" Width="408px"></tm:MyDropDownList></td>
                                            ...
                                            <td>
                                                <tm:MyTextBox ID="ctl_acvMemo" runat="server" WhereText="IsNull(IsNull(DS.acvMemo, DS.acpMemo), '')" WhereOperator="關鍵字" Width="140px"></tm:MyTextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 100px; text-align: right">用途別科目：</td>
                                            <td colspan="3">
                                                <tm:MyDropDownList ID="ctl_acvOutlayCode" runat="server" Width="407px"></tm:MyDropDownList></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="width: 100px; text-align: right" colspan="6">
                                                ...
                                                <table style="table-layout: fixed; width: 100%">
                                                    <tr>
                                                        <td style="text-align: center">
                                                            <asp:Button ID="btnExport" runat="server" Text="匯出Excel" OnClick="btnExport_Click" Height="22" /><asp:Button ID="BtnSave" runat="server" Height="22" Text="傳票號碼登錄存檔" OnClick="BtnSave_Click"></asp:Button></td>
