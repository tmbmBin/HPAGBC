<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UI.SignFlow.Web.Done._Default" %>
<%@ Register TagPrefix="SF" TagName="UCMenuBar" Src="../ascx/UCMenuBar.ascx" %>
<%@ Register TagPrefix="SF" TagName="UCDoneList" Src="ascx/UCDoneList.ascx" %>
...
<div id="content">
	<SF:UCDoneList ID="ucdonelist" runat="server" />
</div><%--content end--%>
