<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCRetrieveList.ascx.cs" Inherits="UI.SignFlow.Web.Form.Retrieve.ascx.UCRetrieveList" %>
...
<asp:Button ID="back" Text="取回" runat="server" CommandName="BackToPreviouLevel" OnClientClick="if(!confirm('確定取回?'))return false;"
