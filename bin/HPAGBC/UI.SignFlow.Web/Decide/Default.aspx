<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UI.SignFlow.Web.Decide._Default" %>
<%@ Register TagPrefix="SF" TagName="UCMenuBar" Src="../ascx/UCMenuBar.ascx" %>
<%@ Register TagPrefix="SF" TagName="UCDecideList" Src="ascx/UCDecideList.ascx" %>
...
<div id="content">
	<SF:UCDecideList ID="decidelist" runat="server" />
</div><%--content end--%>
