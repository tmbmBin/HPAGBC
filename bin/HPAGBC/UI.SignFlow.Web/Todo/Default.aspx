<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UI.SignFlow.Web.Todo._Default" %>
<%@ Register TagPrefix="SF" TagName="UCMenuBar" Src="../ascx/UCMenuBar.ascx" %>
<%@ Register TagPrefix="SF" TagName="UCTodoList" Src="ascx/UCTodoList.ascx" %>
...
<div id="content">
	...
	<SF:UCTodoList ID="todolist" runat="server" />
