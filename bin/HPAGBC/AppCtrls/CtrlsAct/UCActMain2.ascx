...
function UCBidDate_Change(calendar)
        { 
                ...
                for (var i=0;i<document.forms[0].elements.length;i++)
               {
                    ...
                    {
                            e.value= (vDay.getFullYear()-1911) + '/' + (vDay.getMonth()+1) + '/' + vDay.getDate();
                           break; 
                    }
               } 
    ...
    <tr>
        <td colspan=6>
										...
										<tr>
											...
											<td><asp:textbox id="TBBidDate"  MyName="TBBidDate" runat="server" Width="80px" MaxLength="10"  Enabled="False" ondblclick="JavaScript: UCBidDate.Show();"></asp:textbox></td>
											<td style="FONT-SIZE: 12pt; WIDTH: 90px" align="right">合約起始日</td>
											<td><asp:textbox id="TBConBDate"  MyName="TBConBDate"  runat="server" Width="80px" MaxLength="10"  Enabled="False" ondblclick="JavaScript: UCConBDate.Show();"></asp:textbox></td>
										</tr>
										<tr>
											...
											<td><asp:textbox id="TBSignDate"  MyName="TBSignDate"  runat="server" Width="80px" MaxLength="10"  Enabled="False" ondblclick="JavaScript: UCSignDate.Show();"></asp:textbox></td>
											<td style="FONT-SIZE: 12pt; WIDTH: 90px" align="right">合約結束日</td>
											<td><asp:textbox id="TBConEDate" MyName="TBConEDate" runat="server" Width="80px" MaxLength="10"  Enabled="False" ondblclick="JavaScript: UCConEDate.Show();"></asp:textbox></td>
										</tr>
									</table>
