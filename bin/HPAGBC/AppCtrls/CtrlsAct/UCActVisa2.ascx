                                    ...
                                    <div id="div_UCActVisa2" class="DIV1_width" alt="DIV1" style="behavior: url(<%= resolveurl(scrollposurl)%>)"
                                        ...
                                        <asp:DataGrid ID="DataGrid2" runat="server" Width="100%" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn>                                                  
                                                    <HeaderTemplate>
                                                        <%--<table style="table-layout: fixed; border-collapse:collapse;width:815px" border="0" cellpadding="0" cellspacing="0">--%>
                                                          <%--20150826 [mdf]:隱藏控帳業務需修改寬度--%>
                                                           <table style="table-layout: fixed; border-collapse:collapse;width:735px" border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 30px; color: #ffffff;text-align: center">月份</td>
                                                                <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 50px; color: #ffffff;text-align: center">門別</td>
                                                                <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 70px; color: #ffffff;text-align: center">預算來源</td>
                                                                <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 100px; color: #ffffff;text-align: center">經費單位</td>
                                                                 <%--20150826 [mdf]:隱藏控帳業務--%>
                                                              <%--  <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 80px; color: #ffffff;text-align: center">控帳業務</td>--%>
                                                                <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 80px; color: #ffffff;text-align: center; display:none">控帳業務</td>
                                                                ...
                                                                <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 75px; color: #ffffff;text-align: center">動支金額</td>
                                                    ...
                                                    <ItemTemplate>
                                                      <%--  <table style="table-layout: fixed;width:815px; margin-left: 0px" border="0" cellpadding="0" cellspacing="0">--%>
                                                              <%--20150826 [mdf]:隱藏承辦業務需修改寬度--%>
                                                            <table style="table-layout: fixed;width:735px; margin-left: 0px" border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td style="text-align:left">
                                                                  <%--  <table style="table-layout: fixed; border-collapse:collapse;width:785px; margin-left: 0px" border="0" cellpadding="0" cellspacing="0">--%>
                                                                        <%--20150826 [mdf]:隱藏承辦業務需修改寬度--%>
                                                                        <table style="table-layout: fixed; border-collapse:collapse;width:705px; margin-left: 0px" border="0" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td style="border-right: #ffffff 1px solid; width: 30px" ><asp:TextBox ID="TBdgBgtMonth" runat="server" Width="30px" onfocus="this.blur();" style="text-align: center" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgBgtMonth"></asp:TextBox></td>
                                                                            <td style="border-right: #ffffff 1px solid; width: 50px" ><asp:TextBox ID="TBdgAccKindName" runat="server" Width="50px" onfocus="this.blur();" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgAccKindName"></asp:TextBox></td>
                                                                            <td style="border-right: #ffffff 1px solid; width: 70px" ><asp:TextBox ID="TBdgBgtSourName" runat="server" Width="70px" onfocus="this.blur();" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgBgtSourName"></asp:TextBox></td>
                                                                            <td style="border-right: #ffffff 1px solid; width: 100px" ><asp:TextBox ID="TBdgBgtDepName" runat="server" Width="100px" onfocus="this.blur();" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgBgtDepName"></asp:TextBox></td>
                                                                            <%--20150826 [mdf]:隱藏控帳業務--%>
                                                                            <%--  <td style="border-right: #ffffff 1px solid; width: 80px" ><asp:TextBox ID="TBdgBizName" runat="server" Width="80px" onfocus="this.blur();" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgBizName"></asp:TextBox></td>--%>
                                                                            <td style="border-right: #ffffff 1px solid; width: 80px; display:none" ><asp:TextBox ID="TBdgBizName" runat="server" Width="80px" onfocus="this.blur();" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgBizName"></asp:TextBox></td>
                                                                            <td style="border-right: #ffffff 1px solid; width: 200px"><asp:TextBox ID="TBdgPalnName" runat="server" Width="200px" onfocus="this.blur();" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgPalnName"></asp:TextBox></td>
                                                                            ...
                                                                            <td style="border-right: #ffffff 1px solid; width: 75px" ><asp:TextBox ID="TBdgAcvMoney" runat="server" Width="75px" onfocus="this.blur();" style="text-align: right" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgAcvMoney"></asp:TextBox></td>
                                                                            <td style="border-right: #ffffff 1px solid; width: 30px; text-align: center; display:none"><asp:CheckBox ID="CBdgPrePayFlag" runat="server" Enabled="false" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="10" align="right">
                                                                                <asp:DataList ID="DataList1" runat="server" Style="margin-right: 2px" OnItemCreated="DataList1_ItemCreated"
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <table style="table-layout: fixed; margin-left: 0px; border-collapse:collapse" border="0" cellpadding="0" cellspacing="0">
                                                                                            <tr>
                                                                                                <td style="border-right: #ffffff 1px solid; font-size: 10pt; width: 20px; text-align: center"><asp:Label ID="LBdlNo" runat="server" Style="text-align: center; cursor: help" onclick="setShowBudget(this)"><%# Container.ItemIndex +1 %></asp:Label></td>
                                                                                                <td style="border-right: #ffffff 1px solid; width: 30px"  wrap="false">
                                                                                                ...
                                                                                                <td style="border-right: #ffffff 1px solid; width: 30px" ><asp:TextBox ID="TBdlMonth" runat="server" Width="30px" onfocus="this.select();" style="background-color: #FFFFE0; text-align: center" onkeypress="return check_Num()" MyName="TBdlMonth"></asp:TextBox></td>
                                                                                                <td style="border-right: #ffffff 1px solid; width: 80px; padding-top: 1px" ><asp:DropDownList ID="DDLdlAccKind" runat="server" Width="80px" style="background-color: #FFFFE0" MyIndex="<%# Container.ItemIndex  %>" MyName="DDLdlAccKind" ></asp:DropDownList></td>
                                                                                                 <td style="border-right: #ffffff 1px solid; width: 150px; padding-top: 1px" ><asp:DropDownList ID="DDLdlOulName" runat="server" Width="150px" Style="background-color: #FFFFE0" MyIndex="<%# Container.ItemIndex  %>" MyName="DDLdlOulName"></asp:DropDownList></td>
                                                                                                <td style="border-right: #ffffff 1px solid; width: 75px" ><asp:TextBox ID="TBdlAcvMoney" runat="server" Width="75px" onblur="CheckUpLevlMoney(this);GetTotalPayMoney();" onfocus="this.select();" Style="background-color: #FFFFE0; text-align: right" onkeypress="return check_Num()" MyName="TBdlAcvMoney"></asp:TextBox></td>
                                                                                                 
                                                                                                <td style="border-right: #ffffff 1px solid; width: 30px; text-align: center; display:none" ><asp:CheckBox ID="CBdlPrePayFlag" runat="server" /></td>
                                                                                                
                                                                                                <td style="font-size: 10pt; width: 28px; text-align: center" ><asp:CheckBox ID="CBdlDel" runat="server" /></td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </ItemTemplate>
                                                                                </asp:DataList>
                                                                ...
                                                                <td style="font-size: 10pt; width: 30px; text-align:center; vertical-align:bottom">
                                                                    <asp:Button ID="BtnSplit" style="width:20px" runat="server" Text="+" CssClass="<%# Container.ItemIndex %>"
