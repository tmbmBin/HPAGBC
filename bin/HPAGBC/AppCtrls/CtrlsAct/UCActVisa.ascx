                        ...
                        <table cellpadding="0" style="border-collapse: collapse" border="0">
                            <tr>
                                <td width="1%" align="right">
                                    <img id="img_FoldTitle_12" border="0" src="images/minus.gif" onclick="show_item('FoldTitle_12', this.id)" align="top" style="margin-left: 0px; cursor: hand" alt="Collapse/Expand" /></td>
                        ...
                        <table cellpadding="5" cellspacing="0" style="table-layout: fixed" border="0">
                            <tr>
                                <td width="150" align="right">
                                    <img id="img12" border="0" src="images/plus.gif" onclick="scale_item(this.id)" align="top" style="margin-left: -5px; cursor: hand" alt="Collapse/Expand" /><span style="cursor: hand" onclick='img12.fireEvent("onclick")'>預算動支項目</span></td>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td><% Dim scrollPosURL As String = "../../Behavior/ScrollPos.htc"%>
                                    <div id="div_UCActVisa" class="DIV1_width" alt="DIV1" style="behavior: url(<%= resolveurl(scrollposurl)%>)" persistid="<%= savescrollpos.uniqueid %>" scrollpos="<%= savescrollpos.value %>">
