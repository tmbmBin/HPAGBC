<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCOtherVisa.ascx.vb" Inherits="AppCtrls.UCOtherVisa" %>
                        ...
                        <table cellpadding="3" style="border-collapse: collapse; margin-bottom: -2px; width: 100%" border="0">
                            <tr>
                                <td>
                                    ...
                                    <font size="2">
                                        <asp:TextBox ID="TBQty" runat="server" onkeypress="return check_Num()"  style="text-align:center" ToolTip="指定增加列數1~5列" Width="60px"   Enabled="False">1</asp:TextBox>
                                        <asp:CheckBox id="CBCopy" runat="server" Text="複製上筆資料" Enabled="False" />
                                    </font>
                                </td>
                                <td align="right"></td>
                            </tr>
