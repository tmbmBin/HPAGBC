        ...
        <table style="margin-top: 10px; margin-left: 10px; border-collapse: collapse" cellpadding="5" width="800" bgcolor="#dadee9">
            <tr>
                            ...
                            <td>
                                <table border="0" cellpadding="1" cellspacing="1" width="100%" style="table-layout: fixed">
                                    <tr>
                                        ...
                                        <td style="width: 90px">
                                            <asp:TextBox ID="TBCinYear" runat="server" Width="80px" BackColor="Transparent" onfocus="this.blur();" Style="text-align: center"></asp:TextBox></td>
                                        <td align="right" style="width: 70px">撥入編號</td>
                                        <td style="width: 90px">
                                            <asp:TextBox ID="TBCinNo" runat="server" Width="80px" BackColor="Transparent" onfocus="this.blur();" Style="text-align: center"></asp:TextBox></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 90px">
                                            <asp:TextBox ID="TBCinDate" runat="server" ondblclick="JavaScript: UCDate.Show();" Width="80px" Style="text-align: center"></asp:TextBox></td>
                                        <td align="right" style="width: 70px">撥入金額</td>
                                        <td style="width: 90px">
                                            <asp:TextBox ID="TBCinMoney" runat="server" Width="80px" Style="text-align: right" onkeypress="return check_Num()" MyName="TBAcmMoney"></asp:TextBox></td>
                                        <td align="right"></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <asp:TextBox ID="TBMemo" runat="server" Width="457px"></asp:TextBox>
                                    ...
                                    <tr style="display: none">
                                        ...
                                        <td style="width: 120px">
                                            <asp:TextBox ID="TBCsmYear" runat="server" Width="48px"></asp:TextBox></td>
                                        <td align="right">
                                            <asp:TextBox ID="TBCsmNo" runat="server" Width="48px"></asp:TextBox></td>
                                        <td></td>
                                    </tr>
                                </table>
                            </td>
                ...
                <td valign="top" width="200" bgcolor="#ffffff" rowspan="3">
                    <iframe id="iFrame" border="0" name="iFrame" src="FrmShowCash.aspx" frameborder="0" width="200" scrolling="no" height="200"></iframe>
                </td>
            </tr>
            <tr>
                            ...
                            <td valign="bottom" align="left">
                                <table cellpadding="1" border="0">
                                    <tr>
                                        ...
                                        <td valign="bottom" align="center">
                                            <asp:Button ID="BtnAddInital" runat="server" Text="新增期初" Height="22"></asp:Button></td>
                                ...
                                <asp:DataGrid ID="DataGrid1" runat="server" Width="600px" AutoGenerateColumns="False" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="撥還批號">
                                            ...
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="LBCsmNo" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.BatchNo") %>' ToolTip='<%# DataBinder.Eval(Container, "DataItem.csmNo") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        ...
                                        <asp:BoundColumn DataField="csmMemo" HeaderText="備註" Visible="false"></asp:BoundColumn>
                            ...
                            <td align="right">
                                <table style="border-collapse: collapse" cellpadding="0" border="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddl_Sort" runat="server" AutoPostBack="True"></asp:DropDownList><asp:DropDownList ID="DDLSortStatus" runat="server" AutoPostBack="True">
                                                <asp:ListItem Value="">......</asp:ListItem>
