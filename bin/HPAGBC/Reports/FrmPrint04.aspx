<%@ Page  EnableEventValidation="false" Language="vb" AutoEventWireup="false" CodeBehind="FrmPrint04.aspx.vb" Inherits="Reports.FrmPrint04" %>
...
<table style="TABLE-LAYOUT: fixed; MARGIN-TOP: 10px; MARGIN-LEFT: 10px; BORDER-COLLAPSE: collapse"
									...
									<table cellSpacing="0" cellPadding="5" width="100%" border="0">
										...
										<tr>
											...
											<td align="right" width="90">
                                                <asp:Label ID="LBPayName" runat="server" Text="廠商名稱" Visible=false ></asp:Label></td>
											<td style="WIDTH: 150px" align="left"><asp:textbox id="TBPayName" runat="server" Width="144px" Visible=false ></asp:textbox></td>
										</tr>
										<tr>
											<td align="right" width="90"><FONT face="新細明體"></FONT></td>
											<td class=" " width="150"><FONT face="新細明體">&nbsp;</FONT></td>
										...
										<tr>
											<td align="right" width="90" ></td>
											<td >
                                                <asp:CheckBox ID="CBReload" runat="server" Text="重新計算" Visible="False" />
                                            </td>
	...
	<asp:GridView ID="Grid" runat="server" AutoGenerateColumns="true" Visible="false"></asp:GridView>
	<asp:GridView ID="Grid1" runat="server" AutoGenerateColumns="true" Visible="false"></asp:GridView>
    </form>
</body>
</html>
