                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: left">
                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="padding-right: 5px" nowrap>
                                                                                            <asp:CheckBox ID="CBDocFlag" runat="server" Font-Size="X-Small" TextAlign="Right" Text="簽文" Visible="false" /></td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                            <td style="text-align: right">
                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                    <tr>
                                                                                        <td style="padding-right: 5px" nowrap>
                                                                                            <asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行暫付" Visible="True" onclick="showfiled(this);chkTmpPayAndCash();" /></td>
                                                                                        <td style="padding-right: 5px" nowrap>
                                                    ...
                                                    <td style="padding: 0px">
                                                        <table cellpadding="1" cellspacing="0" style="table-layout: fixed" border="0">
                                                            <tr style="">
                                                                ...
                                                                <td width="100">
                                                                    <input id="TBOtherUnitFlag" type="hidden" runat="server" /></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="5">
                                                                    <asp:TextBox ID="TBAcmPayName" runat="server" ondblclick='fnCallPhraseDialog("TBAcmPayName");' Width="472px"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td width="100" align="right">事　　由</td>
                                                                <td width="500" colspan="5" nowrap>
                                                                    <asp:TextBox ID="TBAcmSubMemo" runat="server" Style="background-color: #FFFFE0" Width="472px" Rows="2" TextMode="MultiLine"></asp:TextBox><input type="button" id="BtnSubPhrase" runat="server" style="height: 22px; width: 18px" value="..." onclick="fnCallPhraseDialog('TBAcmSubMemo');" /></td>
                                                            </tr>
                                                            <tr>
