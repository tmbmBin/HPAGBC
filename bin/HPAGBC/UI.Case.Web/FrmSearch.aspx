<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmSearch.aspx.vb" Inherits="UI.Case.Web.FrmSearch" %>
...
<head runat="server">
	...
	<script language="javascript" type="text/javascript">
		...
		function fnGetInfo() {
            ...
            if (document.getElementById("DDLAccKind").value != "")
		    {
 ...
 if (document.getElementById("DDLBgtSource").value != "") {
		        //var tmpArray ;				 			 
		        ...
		        switch ("<%=strStageFlag%>") {
		            case "3":
		                strValue += " And IsNull(V1.acvBgtSourceCode, V.acvBgtSourceCode) = '" + document.getElementById("DDLBgtSource").value + "'";
		                break;
		            case "11":
		                strValue += " And IsNull(V2.acvBgtSourceCode, IsNull(V1.acvBgtSourceCode, V.acvBgtSourceCode)) = '" + document.getElementById("DDLBgtSource").value + "'";
		                break;
		            case "12":
		                strValue += " And IsNull(PV.acvBgtSourceCode, IsNull(V2.acvBgtSourceCode, IsNull(V1.acvBgtSourceCode, V.acvBgtSourceCode))) = '" + document.getElementById("DDLBgtSource").value + "'";
		                break;
		            case "13":
		                strValue += " And IsNull(PV1.acvBgtSourceCode, PV.acvBgtSourceCode) = '" + document.getElementById("DDLBgtSource").value + "'";
		                break;
		            default:
		                strValue += " And V.acvBgtSourceCode= '" + document.getElementById("DDLBgtSource").value + "'";
