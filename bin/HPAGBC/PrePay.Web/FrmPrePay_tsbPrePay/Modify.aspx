                ...
                <ItemTemplate>
                    <table class="MainCon3" style="width: 100%; vertical-align: top" border="1">
                        ...
                        <tr>
                            ...
                            <td class="qury_table_td">預撥金額</td>
            ...
            <table style="width: 100%;" border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="ddlcodBiz" runat="server" onfocus="blur()" Style="display: none"></asp:DropDownList>
                        <!-- 控帳業務 -->
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txttsbMoney" runat="server" Width="96%" onfocus="alert('禁止修改');blur()" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txttsbMoney1" runat="server" Width="97%" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}"></asp:TextBox>
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        try {
                            ...
                            if (checkNullEmpty(result.tsbDecideDtlDTO.tsbPayeeNo))
                            { $("#<%= txtEtsbPayeeNo.ClientID %>").val(result.tsbDecideDtlDTO.tsbPayeeNo); }
                            if (checkNullEmpty(result.tsbDecideDtlDTO.tsbMoney))
                            { $("#<%= txttsbMoney.ClientID %>").val(result.tsbDecideDtlDTO.tsbMoney); }
                              if (checkNullEmpty(result.tsbDecideDtlDTO.tsbApplySeq))
