<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCActPayTrlDtl.ascx.vb" Inherits="UI.TrlMixPay.UC.UCActPayTrlDtl" %>
                    ...
                    <td style="padding: 5px">
                        <table cellpadding="5" cellspacing="0" style="table-layout: fixed" border="0">
                            <tr>
                                ...
                                <td width="100" align="right">
                                    <span style="display: none">美金匯率：</span></td>
                                <td width="100" align="right" style="display: none">
                                    <asp:TextBox ID="ctl_aceMoney" runat="server" Width="80px"
                                        onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                        onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value=fmtMoney(this.value);};"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <div id="div_UCActPayVisa" class="DIV1_width" alt="DIV1">
                            ...
                            <asp:GridView ID="GV_actPayDtlTrl" runat="server" BackColor="White" BorderColor="#999999"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="日期(起)">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="日期(訖)">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="地點(訖)">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="工作記要">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="生活費">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlAllowanceCrnMoney" onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value=fmtMoney(this.value);};GetTotalTrlRowMoney(this.id,'ctl_AcdTrlAllowanceCrnMoney');"
                                                MaxLength="8"
                                                runat="server"
                                                Width="60px" Enabled="True" DBFieldName="acdTrlAllowanceCrnMoney"></asp:TextBox>
                                        </ItemTemplate>
                                        <HeaderStyle Width="60px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="報名費">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="住宿費">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlStay" onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                ...
                                                MaxLength="8"
                                                runat="server"
                                                Width="60px" Enabled="True" DBFieldName="acdTrlStay"></asp:TextBox>
                                        </ItemTemplate>
                                        <HeaderStyle Width="60px" />
                                    </asp:TemplateField>
