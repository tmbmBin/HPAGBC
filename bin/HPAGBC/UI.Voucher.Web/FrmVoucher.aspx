...
<body>
	...
	<table style="MARGIN-TOP: 10px; MARGIN-LEFT: 10px; BORDER-COLLAPSE: collapse" cellPadding="5" width="900" bgColor="#dadee9">
									...
									<table cellPadding="1" border="0">
										<tr>
											...
											<td vAlign="bottom" align="center">
                                                <asp:Button ID="btnExport" runat="server" Text="匯出Excel" />
                                            </td>
											...
											<td vAlign="bottom" align="center"><asp:label id="LBPayTotal" runat="server" Width="100px"></asp:label></td>
											<td vAlign="bottom" align="center">轉正總和：</td>
											<td vAlign="bottom" align="center"><asp:label id="LBOffsetTotal" runat="server" Width="100px"></asp:label></td>
											<td vAlign="bottom" align="center">繳回總和：</td>
											<td vAlign="bottom" align="center"><asp:label id="LBPayBackTotal" runat="server" Width="100px"></asp:label></td>
										</tr>
									</table>
								</td>
							</tr>
            ...
            <table style="MARGIN-TOP: 10px; MARGIN-LEFT: 10px; BORDER-COLLAPSE: collapse;display :none" cellPadding="5"
				width="900" bgColor="#dadee9" >
				<tr>
					<td style="BORDER-RIGHT: #666668 1pt solid; BORDER-TOP: #666668 1pt solid; BORDER-LEFT: #666668 1pt solid; BORDER-BOTTOM: #666668 1pt solid" borderColor="#666668">
						<asp:DataGrid ID="DataGrid2" runat="server" Width="900px" CellSpacing="1" BorderStyle="None" BorderWidth="1px" CellPadding="3" BackColor="White" BorderColor="#999999"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="傳票號碼">
									<ItemTemplate>
										<asp:label id="TBdgAccNo" runat="server" Width="70px" Text ='<%# DataBinder.Eval(Container, "DataItem.acvExchNo") %>' tooltip='<%# AntiXss.HtmlEncode(DataBinder.Eval(Container, "DataItem.acvExchNo").ToString()) %>'>
										</asp:label>
									</ItemTemplate>
								</asp:TemplateColumn>
                                <asp:BoundColumn Visible="True" DataField="acpPayNo" SortExpression="acpPayNo" HeaderText="報支號"></asp:BoundColumn>
                                <asp:TemplateColumn HeaderText="繳回款傳票號碼">
									<ItemTemplate>
										<asp:label id="TBdgOffSetAccNo" runat="server" Width="70px" Text ='<%# DataBinder.Eval(Container, "DataItem.acvExchNo1") %>' tooltip='<%# AntiXss.HtmlEncode(DataBinder.Eval(Container, "DataItem.acvExchNo1").ToString()) %>' >
										</asp:label>
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>	
