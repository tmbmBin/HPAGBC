...
<script runat="server">
	...
	Function get_Members() As System.Data.IDataReader
        ...
        Dim queryString As String = "SELECT [PK_usrNo], [UsrAlias], [UsrName], ISNULL((select top 1 dptName from codDepartName where dptCode=depcode), ISNULL([usrTeamCode], '')) AS [usrTeamCode] FROM [sysBaseUser] ORDER BY [usrTeamCode], [UsrAlias]"
	...
	Function get_Group(ByVal PK_grpNo As Integer) As System.Data.IDataReader
        ...
        Dim queryString As String = "SELECT [sysUserPower].[PK_usrNo], CONVERT(nvarchar, [sysBaseUser].[usrAlias]) + ' ' + [sysBaseUser].[usrName] + '(' + ISNULL((select top 1 dptName from codDepartName where dptCode=depcode),IsNull( [sysBaseUser].[usrTeamCode],'')) + ')' AS [usrInfo] "& _
	...
	Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        If DB.sysMenu.DAT.sysMenuBZ.Request("mod")<>"2" Then '只能授權自已所擁有的 '97.12.16	'nickey
	...
	<form runat="server">
		...
		<table style="margin-left: 15; margin-top: 15" cellspacing="0" cellpadding="0" border="0">
				...
				<td width="100">
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td style="padding-left: 1px" nowrap><p style="margin-top: 2px"><font size="2" color="#000080">群組成員<font face="Verdana" size="1"> (<%=gNum %>)</font></font></td>
						</tr>
					</table>
				</td>
				<td align="middle" width="50">
				...
				<td width="100">
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td style="padding-left: 1px" nowrap><p style="margin-top: 2px"><font size="2" color="#000080">現有成員<font face="Verdana" size="1"> (<%=mNum %>)</font></font></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				...
				<td align="middle" width="50">
					<asp:Button id="btn_add" onclick="btn_add_Click" runat="server" Width="25px" Text="&laquo;" Height="22px" ToolTip="加入指定的成員"></asp:Button>
					<asp:Button id="btn_remove" onclick="btn_remove_Click" runat="server" Width="25px" Text="&raquo;" Height="22px" ToolTip="移除指定的成員"></asp:Button>
				</td>
				<td width="100" valign="top">
			...
			<tr>
				<td width="100" valign="top" style="padding-top: 2px">
					<asp:Button id="btn_edit" onclick="btn_edit_Click" runat="server" Width="50px" Text="編輯" Height="22px"></asp:Button><asp:Button id="btn_delete" onclick="btn_delete_Click" runat="server" Width="50px" Text="刪除" Height="22px" Visible="False"></asp:Button>
				</td>
