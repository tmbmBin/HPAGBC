...
<script runat="server">
	...
	Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        lit_info.Text = "" & _
         "<a href='UI.SystemData.Web/FrmSysEnv.aspx?MenuAlias=" & Server.UrlEncode("{作業年月設定}") & "' target='main' style='text-decoration:none' onFocus='if(this.blur)this.blur();'>" & _
         "<font color='white' style='font-size: 8pt'>作業年度 <u><font style='font-size: 14pt' color='DarkOrange'>" & Session("default_Year") & "</font></u>" & _
         "∕月份 <u><font style='font-size: 14pt' color='DarkOrange'>" & Session("default_Month") & "</font></u>" & _
         "∕操作身分 <u><span title='" & Session("default_UnitNo") & "'>" & Session("default_UnitName") & "</span></u>" & _
         "：<u><span title='" & Session("default_UserNo") & "'>" & Session("default_UserName") & "</span></u>" & _
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td valign="top"><a onclick="movePanel();" style="CURSOR: hand"><img name="panel_btn" border="0" src="images/title_logo.gif" alt="« 隱藏選單" width="60" height="34"></a></td>
						<td valign="top" nowrap>
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td><img border="0" src="images/title_split.gif" width="16" height="34"></td>
								<td><img border="0" src="images/title_item_left.gif" width="8" height="34"></td>
								<td align="center" valign="top" style="background-image: url('images/title_item_bg.gif'); background-repeat: repeat-x; background-position-y: top; padding-top:4px; padding-left:7px; padding-right:7px" nowrap><font color="#FFFFFF"><asp:Label id="lit_Title" runat="server" style="font-size: 12pt">系統</asp:Label></font>&nbsp;<sup><asp:Label id="lab_IsNew" runat="server" forecolor="DarkOrange"></asp:Label></sup></td>
								<td><img border="0" src="images/title_item_right.gif" width="8" height="34"></td>
                                <%--<td style="color:Red; font-weight:bold"><%= System.Configuration.ConfigurationManager.AppSettings("SysCateName")%></td>--%>
							</tr>
						</table>
						</td>
					</tr>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td><img border="0" src="images/title_split.gif" width="16" height="34"></td>
						<td align="right" valign="top" style="padding-top:3px; padding-left: 5px; padding-right: 10px" nowrap><asp:Literal id="lit_info" runat="server"></asp:Literal></td>
					</tr>
				</table>
				</td>
			</tr>
