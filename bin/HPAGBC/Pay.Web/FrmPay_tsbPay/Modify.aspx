    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel2" runat="server" Width="100%">
            ...
            <div style="display: none">
                ...
                <asp:TextBox ID="txtEselectEstimateData" runat="server" onfocus="blur()" Style="display: 1none"></asp:TextBox>
                <!--選擇估列字串--->
            </div>
        ...
        <script type="text/javascript">
            ...
            $("#btnSave").click(function () {
                if ($("#form1").valid()) {
                    ...
                    //$.blockUI({ message: "<h3><b><img src='../../Images/ajax-loader.gif' />資料儲存中，請稍後...</b></h3>" });
