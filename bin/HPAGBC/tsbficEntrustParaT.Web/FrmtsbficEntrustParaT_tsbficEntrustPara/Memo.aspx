...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="ODS_Travel" runat="server" TypeName="ShareTable.DAO.tsbMemoDAO" OldValuesParameterFormatString="original_{0}" SelectMethod="getList" SelectCountMethod="getListCount">
            <SelectParameters>
                <asp:SessionParameter DefaultValue="" Name="tsbYear" SessionField="default_Year" Type="Int16" />
                <asp:Parameter Name="acpTrlKind" Type="String" DefaultValue="1" />  <%-- 出差種類 (1:國內 2:國外) --%>
            </SelectParameters>
        </asp:ObjectDataSource>
        <br />
        <div class="MainCon2" style="width: 90%">
            <h1 class="h1Class">備註資料選取</h1>
