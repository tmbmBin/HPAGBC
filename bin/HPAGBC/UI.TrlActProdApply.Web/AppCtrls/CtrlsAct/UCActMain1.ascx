<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCActMain1.ascx.vb" Inherits="UI.TrlActProdApply.Web.UCActMain1" %>
...
<table border=0 cellpadding=1 cellspacing=1 width="600px" style="table-layout:fixed">
  <tr style="display:none">
    ...
    <tr>
        ...
        <td style="width: 120px"><asp:TextBox ID="TBAcmMoney1" runat="server" Width="90px" 
                BackColor="Transparent" onfocus="this.blur();"  style="text-align:right" 
                MyName ="TBAcmMoney1"></asp:TextBox></td>
    ...
    <tr>
        ...
        <td style="width: 120px"><asp:DropDownList ID="DDLWorkDep"  
    ...
    <tr>
        ...
        <td colspan="5">
            <asp:TextBox ID="TBAcmSubMemo" style="BACKGROUND-COLOR: #ffffe0" runat="server" 
                Width="480px" Enabled="False" MyName="TBAcmSubMemo" Rows="2" 
    ...
    <tr >
        ...
        <td colspan="5">
            <asp:TextBox ID="TBAcmMemo"  runat="server" Width="480px" Enabled="False" 
                MyName="TBAcmMemo" Rows="2" TextMode="MultiLine"></asp:TextBox><input id="BtnPhrase" runat="server" type="button" value="..." disabled="disabled" />
       </td>
    </tr>
 <tr id="TRTmpPayData"  >
