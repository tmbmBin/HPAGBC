<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmTrlPayForeignV1.aspx.vb" Inherits="UI.TrlActMixPay.Web.FrmTrlPayForeignV1" %>
...
<%@ Register Src="../UI.ActMixPay.UC/UCActPayMixTrl.ascx" TagName="UCActPayMixTrl" TagPrefix="uc3" %>
                                ...
                                <table cellpadding="0" style="border-collapse: collapse" border="1" bordercolor="#666668" bgcolor="#DADEE9">
                                    <tr>
                                        <td style="padding-top: 1px" onpropertychange="try{childNodes.width = this.clientWidth;}catch(e){;};">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                            <tr>
                                                                <td style="padding-right: 5px" nowrap>
                                                                    <asp:CheckBox ID="CBAllowanceFlag" runat="server" Font-Size="X-Small" TextAlign="Right" Text="零用金" Visible="True" Style="display: none" /></td>
                                                                <td style="padding-right: 5px; display: block" nowrap>
                                                                    <asp:CheckBox ID="CBSeparateFlag" runat="server" Font-Size="X-Small" TextAlign="Right" Text="分期付款" Visible="True" Enabled="False" Style="display: none" /></td>
                                                                <td style="padding-right: 5px" nowrap>
                                                                    <asp:CheckBox ID="CBEPayment" runat="server" Font-Size="X-Small" TextAlign="Right" Text="電子支付" Visible="True" Style="display: none" /></td>
                                                                <td style="padding-right: 5px; display: block" nowrap>
                                                                    <asp:CheckBox ID="CBDocFlag" runat="server" Font-Size="X-Small" TextAlign="Right" Text="簽文" Visible="True" Enabled="False" onclick="ShowProdData();" Style="display: none" /></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                            ...
                                            <!-- 區塊(2)↑ -->
                                            <!-- ↓區塊(3) -->
                                            <uc3:ucactpaymixtrl id="UCActPayMixTrl1" runat="server" />
                                            <!-- 區塊(3)↑ -->
                                            <!-- ↓區塊(4) -->
