<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UI.tsbReports.Web.FrmactReport01.Default" %>
    ...
    <div>
                ...
                <table style="width: 100%;">
                       ...
                       <tr>
                         <td class="qury_table_td">計畫名稱</td>
                            <td class="qury_table_td2">
                                <asp:DropDownList ID="ddlplnPlanCode" runat="server" Width="650px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                </table>
        ...
        <script type="text/javascript">
            ...
            function setplanCode() {
                var tmpstop = "0";
                $('#<%= ddlplnPlanCode.ClientID %> option[value=' + tmpstop + ']').attr('style', "color:red").attr("disabled", "true");
            }
        </script>
    </form>
</body>
