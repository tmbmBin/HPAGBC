<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UI.tsbReports.Web.FrmtsbReport05.Default" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="pnlSearch" runat="server" class="MainCon3">
                <h1 class="h1Class">公款補(捐)助團體、縣市政府及個人情形季報表</h1>
                <table style="width: 100%;">
                    <tr>
                        <td class="qury_table_td">季別</td>
                        <td class="qury_table_td2">
                            <asp:DropDownList ID="ddlSeasonType" runat="server" Width="100px">
                            </asp:DropDownList>
                        </td>
                        <td class="qury_table_td">審定狀態</td>
                        <td class="qury_table_td2">
                            <asp:DropDownList ID="ddltsbIsAudit" runat="server" Width="100px">
