...
<script language="javascript" type="text/javascript">
		...
		function UCDate_Change(calendar)
		{
			...
			document.getElementById("TBAcmMarkDate1").value = (vDay.getFullYear()-1911) + '/' + (vDay.getMonth()+1) + '/' + vDay.getDate();
		}
...
.DIV1_width { width: 590px; height: 119px; overflow: auto; border-style: groove; border-width: 1px; }
									...
									<table cellpadding="0" style="border-collapse: collapse; width: 100%" border="0">
										<tr>
											...
											<table cellpadding="0" cellspacing="0" border="0">
												<tr>
													<td style="padding-right: 5px" nowrap><asp:CheckBox id="CBSeparateFlag" 
                                                            runat="server" Font-Size="X-Small" TextAlign="Right" Text="分期付款" 
                                                            Visible="False" /></td>
													<td style="padding-right: 5px" nowrap><asp:CheckBox id="CBDocFlag" runat="server" 
                                                            Font-Size="X-Small" TextAlign="Right" Text="簽文" Visible="False" /></td>
													<td style="padding-right: 5px" nowrap><asp:CheckBox id="CBAllowanceFlag" 
										...
										<%--	<table cellpadding="0" cellspacing="0" border="0" style="display:none">--%>
												...
												<tr>
													...
													<td align="right" style="padding-left: 5px" nowrap><asp:CheckBox id="CBAccPassFlag" runat="server" Font-Size="X-Small" TextAlign="Left" Text="會計室審核" Visible="true" /></td>
												</tr>
											</table>
											</td>
										</tr>
								...
								<tr>
									...
									<table cellpadding="1" cellspacing="1" style="TABLE-LAYOUT: fixed" border="0">
										<tr>
											...
											<td width="110"><asp:TextBox id="TBAcmWordNum" runat="server" style="text-align: center" BackColor="Transparent" Width="80px" onfocus="this.blur();">09601234</asp:TextBox><asp:TextBox id="TBWordSubNum" runat="server" style="text-align: center" BackColor="Transparent" Width="18px" onfocus="this.blur();">0</asp:TextBox></td>
											<td width="70" align="right">請示日期</td>
											<td width="120"><asp:TextBox id="TBAcmMarkDate" runat="server" MyName="TBAcmMarkDate" style="text-align: center" BackColor="Transparent" Width="110px" onfocus="this.blur();"></asp:TextBox></td>
											<td width="85" align="right">動支金額</td>
											<td ><asp:TextBox id="TBAcmMoney" runat="server" MyName="TBAcmMoney" style="text-align: right" BackColor="Transparent" Width="90px" onfocus="this.blur();"></asp:TextBox></td>
										</tr>
									</table>
									</td>
								</tr>
						...
						<tr>
							...
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									...
									<td><asp:button id="BtnPrint" runat="server" Text="列印" Visible="False" Height="22"></asp:button></td>
									<td style="display: none"><input type="button" id="BtnPrint1" runat="server" style="width: 50px; height: 22px" value="列印" onclick="fnCallPrntWeb();" /></td>
									<td></td>
						...
						<tr>
							...
							<asp:datagrid id="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True" PageSize="5">
								...
								<Columns>
                                    ...
                                    <asp:BoundColumn DataField="TotalBidMoney" HeaderText="決標金額" DataFormatString="{0:#,#}" SortExpression="TotalBidMoney" >
										<HeaderStyle Width="70px"></HeaderStyle>
										<ItemStyle HorizontalAlign="Right"></ItemStyle>
									</asp:BoundColumn>
