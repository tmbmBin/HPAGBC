<%@ Page MaintainScrollPositionOnPostback="true" Language="vb" AutoEventWireup="false" CodeBehind="FrmCasePay.aspx.vb" Inherits="UI.Case.Web.FrmCasePay" %>
	    ...
	    <table border="0" cellpadding="0"cellspacing="0"  style="background-color: Aqua">
	        <tr>
	            <td><asp:Label ID="LBDataMsg" runat="server" Text="" ForeColor="Red" Font-Size="X-Small" ></asp:Label></td>
											   ...
											   <table cellpadding="0" cellspacing="0" border="0" style="table-layout:fixed; width:600px">
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right">
                                                            <table cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    <td style="padding-right: 5px" nowrap><asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行暫付" Visible="True" onclick="showfiled(this);chkTmpPayAndCash();" Enabled="False" /></td>
							...
							<!-- ↓區塊(4) --><!-- 區塊(4)↑ --> <asp:PlaceHolder ID="PlaceHolder8" runat="server"></asp:PlaceHolder>
							<!-- ↓區塊(5) --><!-- 區塊(5)↑ --> <asp:PlaceHolder ID="PlaceHolder9" runat="server"></asp:PlaceHolder>
							...
							<asp:datagrid id="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True" PageSize="5">
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="承辦人員" SortExpression="acmWorkUserNo">
										<ItemTemplate>
											<asp:Label runat="server" Text='<%# AntiXss.HtmlEncode(DataBinder.Eval(Container, "DataItem.acmWorkUserNo").ToString()) %>' ToolTip='<%# AntiXss.HtmlEncode(DataBinder.Eval(Container, "DataItem.acmEmpNo").ToString()) %>' ondblclick="clipboardData.setData('text', this.title)" ></asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
