<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmSearchPay.aspx.vb" Inherits="UI.TrlActMixPay.Web.FrmSearchPay" %>
    ...
    <script language="javascript" >
        ...
        function fnGetInfo() {
            ...
            if (document.all("TBAcmPayName").value != "") {
                ...
                strValue += " And IsNull(M1.acmPayName, M.acmPayName)  Like '%" + document.all("TBAcmPayName").value + "%'";
								...
								<td>
									<table border="0" width="100%" cellpadding="1" style="BORDER-COLLAPSE: collapse">
										...
										<tr>
											...
											<td align="right" width="80"><FONT face="新細明體">執行單位</FONT></td>
