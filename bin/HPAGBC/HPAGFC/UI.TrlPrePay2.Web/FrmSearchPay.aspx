<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmSearchPay.aspx.vb" Inherits="UI.TrlPrePay2.Web.FrmSearchPay" %>
   ...
   <title></title>
    ...
    <script language="javascript" >
        ...
        function fnGetInfo() {
            ...
            if (document.all("TBAcmPayName").value != "") {
                //strValue= strValue +  ' and A.acmMemo Like ' + "'" + document.all("TBMemo").value + "%'";
                //if ( strValue !="" ){strValue += '|';}			
                strValue += " And IsNull(M1.acmPayName, M.acmPayName) Like '%" + replaceString(document.all("TBAcmPayName").value, "'", "''") + "%'";
            }
								...
								<td>
									<table border="0" width="100%" cellpadding="1" style="BORDER-COLLAPSE: collapse">
										...
										<tr >
											...
											<td  >
												<asp:TextBox id="TBAcmPayName" runat="server" Width="116px"></asp:TextBox></td>
