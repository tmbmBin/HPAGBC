									...
									<table cellSpacing="0" cellPadding="5" width="100%" border="0">
										<tr>
											...
											<td colSpan="2"><asp:textbox id="TBBDate" ondblclick="JavaScript: UCBDate.Show();" runat="server" Width="80px"></asp:textbox><COMPONENTART:CALENDAR id="UCBDate" runat="server" CultureId="1028" CalendarTitleCssClass="title" DayCssClass="day"
													...
													CalendarCssClass="calendar" PopUpExpandControlId="TBBDate" PopUp="Custom" ClientSideOnSelectionChanged="UCBDate_Change"></COMPONENTART:CALENDAR>至<asp:textbox id="TBEDate" ondblclick="JavaScript: UCEDate.Show();" runat="server" Width="80px"></asp:textbox><COMPONENTART:CALENDAR id="UCEDate" runat="server" CultureId="1028" CalendarTitleCssClass="title" DayCssClass="day"
										...
										<tr>
											...
											<td style="WIDTH: 150px" align="left" style="<%=ShowFlag(5)%>"><font face="新細明體"><asp:dropdownlist id="DDLWorkDep" runat="server" Width="144px"></asp:dropdownlist></font></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td width="150"><asp:checkbox id="CBDownLoad" runat="server" Text="下載報表" Checked="True"></asp:checkbox></td>
										</tr>
									</table>
								</td>
							</tr>
