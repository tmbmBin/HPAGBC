        ...
        <div>
            ...
            <asp:FormView ID="FormView1" Style="width: 100%;" runat="server">
                <ItemTemplate>
                    <table class="MainCon3" style="width: 100%; vertical-align: top" border="1">
                        ...
                        <tr>
                            <td class="qury_table_td1">委辦事項</td>
                            <td colspan="9" class="qury_table_td2">
            ...
            <div runat="server" id="editDiv">
                <table style="width: 100%; background-color: white;" border="1">
                    <%--                  <tr>
                        <td class="qury_table_td" style="background-color: #CCFFCC;" rowspan="2">受委辦單位徵選方式</td>
                        ...
                        <td class="qury_table_td5">
                            <asp:TextBox ID="txtDirectEntrustCause" runat="server" Width="98%"></asp:TextBox>
                        </td>
                    </tr>
                   <tr>
                        <td class="qury_table_td1" style="background-color: #CCFFCC;">徵選辦理方式</td>
                        <td class="qury_table_td5">
                            <asp:TextBox ID="txtSelectProcessMode" runat="server" Width="98%"></asp:TextBox>
                        </td>
                    </tr>
                    --%>
                    <tr>
                        <td class="qury_table_td" style="background-color: #CCFFCC;">合約金額</td>
                        <td class="qury_table_td5">
                            <asp:TextBox ID="txtContractMoney" runat="server" Width="140px"></asp:TextBox>
                        </td>
                        <td class="qury_table_td" style="background-color: #CCFFCC;">簽約日期</td>
                        <td class="qury_table_td5">
                            <asp:TextBox ID="txtContractDate" runat="server" Width="140px" MyKendoDatePicker="MyKendoDatePicker" onclick="blur()"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="qury_table_td" style="background-color: #CCFFCC;">完成時間(預定)</td>
                        <td class="qury_table_td5">
                            <asp:TextBox ID="txtContractBDate" runat="server" Width="140px" MyKendoDatePicker="MyKendoDatePicker" onclick="blur()"></asp:TextBox>
                        </td>
                        <td class="qury_table_td" style="background-color: #CCFFCC;">計畫執行期間(起日)</td>
                        <td class="qury_table_td4">
                            <asp:TextBox ID="txtPlanBDate" runat="server" Width="140px" MyKendoDatePicker="MyKendoDatePicker" onclick="blur()"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="qury_table_td" style="background-color: #CCFFCC;">完成時間(實際)</td>
                        <td class="qury_table_td5">
                            <asp:TextBox ID="txtContractEDate" runat="server" Width="140px" MyKendoDatePicker="MyKendoDatePicker" onclick="blur()"></asp:TextBox>
                        </td>
                        <td class="qury_table_td" style="background-color: #CCFFCC;">計畫執行期間(迄日)</td>
                        <td class="qury_table_td4" colspan="3">
                            <asp:TextBox ID="txtPlanEDate" runat="server" Width="140px" MyKendoDatePicker="MyKendoDatePicker" onclick="blur()"></asp:TextBox>
                        </td>
                    </tr>
                    <%--用不到，暫時隱藏起來--%>
