<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="UI.actEstimateAudit.Web.FrmactEstimateAudit_actPay.Modify" %>
    ...
    <form id="form1" runat="server">
            ...
            <asp:FormView ID="FormView1" Style="width: 100%;" runat="server">
                <ItemTemplate>
                    <table class="MainCon3" style="width: 100%; vertical-align: top" border="1">
                        <tr>
                            ...
                            <td class="qury_table_td2">
                                ...
                                <div style="display: none">
                                    ...
                                    acmNoPrv<asp:TextBox ID="txtacmNoPrv" runat="server" Text='<%# Eval("acmNoPrv") %>' Enabled="false" Style="display: 1none"></asp:TextBox>
                                    acpPayYear<asp:TextBox ID="txtacpPayYear" runat="server" Text='<%# Eval("acpPayYear") %>' Enabled="false" Style="display: 1none"></asp:TextBox>
                                    acpPayNo<asp:TextBox ID="txtacpPayNo" runat="server" Text='<%# Eval("acpPayNo") %>' Enabled="false" Style="display: 1none"></asp:TextBox>
                                </div>

                            </td>
                            <td class="qury_table_td">報支金額
                            </td>
                            <td class="qury_table_td2">
                                <%--  <asp:Label ID="lblAcmMoney" runat="server" Text='<%# Eval("AcmMoney") %>'></asp:Label>--%>
                        ...
                        <tr>
                            <td class="qury_table_td">減列人員</td>
                            <%--核銷人員--%>
                            <td class="qury_table_td2">
                        ...
                        <tr>
                            ...
                            <td class="qury_table_td4" colspan="3">
                                <asp:TextBox ID="txtMemo" runat="server" Text='<%#: Eval("acmMemo") %>' Width="70%" TextMode="MultiLine"></asp:TextBox><%--核銷事由--%>
                        ...
                        <tr>
                            ...
                            <td class="qury_table_td4" colspan="3">
                                <asp:TextBox ID="txtSubMemo" runat="server" Text='<%#: Eval("acmSubMemo") %>' Width="70%" TextMode="MultiLine"></asp:TextBox><%--控帳事由--%>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
        ...
        <div runat="server" id="editDiv">
            ...
            <table style="width: 100%;" border="1">
                <tr>
                    <td class="DtleditTd"><span style="color: Red;">＊</span>審定減列金額(請輸入正值)</td>
            ...
            <asp:GridView ID="GridView1" runat="server" MyName="gvList" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="報支金額" Visible="True">
                        <ItemTemplate>
                            <asp:Label ID="lblAcvMoney" runat="server" Text='<%# Eval("acvMoney").ToMoney() %>'></asp:Label>
                            <asp:Label ID="lblTotalPaid" runat="server" Text='<%# Eval("TotalPaid").ToMoney()  %>' Style="display: none"></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" Width="300" />
                        <ItemStyle HorizontalAlign="Center" Width="300" />
                    </asp:TemplateField>
