...
<body>
    ...
    &nbsp;<table style="TABLE-LAYOUT: fixed; MARGIN-TOP: 10px; MARGIN-LEFT: 10px; BORDER-COLLAPSE: collapse; width: 680px;" borderColor="#666668" cellPadding="5" bgColor="#dadee9" border="1">
								...
								<td>
									<table cellSpacing="1" cellPadding="1" width="100%" border="0">
										<tr style="<%=ShowFlag(1)%>">
											...
											<td colSpan="3"><asp:textbox id="TBBDate" ondblclick="JavaScript: UCBDate.Show();" runat="server" Width="80px" ToolTip="滑鼠快點二下選擇日期"></asp:textbox>至<asp:textbox id="TBEDate" ondblclick="JavaScript: UCEDate.Show();" runat="server" Width="80px" ToolTip="滑鼠快點二下選擇日期"></asp:textbox>
										...
										<tr style="<%=ShowFlag(4)%>">
											...
											<td colspan="3" valign="top"><asp:dropdownlist id="DDLPlan" runat="server" AutoPostBack="True" Width="473px"></asp:dropdownlist></td>
											<td></td>
										</tr>
										<tr style="<%=ShowFlag(5)%>">
											<td align="right" width="90">用途別科目</td>
											<td colspan="3" valign="top"><asp:dropdownlist id="DDLOul" runat="server" 
                                                    Width="473px"></asp:dropdownlist></td>
											<td></td>
										</tr>
										<tr style="<%=ShowFlag(8)%>">
										...
										<tr style="<%=ShowFlag(9)%>">
										    ...
										    <td colspan="3"><asp:TextBox ID="txt_acpSubMemo" runat="server" Width="470px"></asp:TextBox></td>
										    <td></td>
										</tr>
										<tr style="<%=ShowFlag(6)%>">
			...
			<table style="TABLE-LAYOUT: fixed; MARGIN-TOP: 10px; MARGIN-LEFT: 10px; BORDER-COLLAPSE: collapse; width: 900px;" cellPadding="5">
				<tr>
					<td style="width:102px"><asp:Button ID="btn_Show" runat="server" Text="預覽報表" /></td>
					<td>
