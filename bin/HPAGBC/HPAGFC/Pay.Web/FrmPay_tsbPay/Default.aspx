    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div style="text-align: center; margin: 10px;">
                ...
                &nbsp;&nbsp;
                <input type="button" id="btnPrint2" value="列印轉正單" class="Btn02" style="display: none" />
            ...
            <div class="MainCon2">
                ...
                <%--20150918 [add]:儲存 季報設定 MenuID--%>
                <input type="hidden" id="hdfRptMenuID" runat="server" />
                <div>
            ...
            $(function () {
                ...
                $("#btnViewExchNo").click(function () {
                    ...
                    if (selectedTr.length > 0) {
                        ...
                        var BtsbApplyNo = selectedTr.prop("title").split("_")[1];
                        var BtsbDecideNo = selectedTr.prop("title").split("_")[2];
                        var BtsbPrePayYear = selectedTr.prop("title").split("_")[0];//先預設跟年度依樣
                        var BtsbApplySeq = "";
                        var BtsbDecideSeq ="";
                        var CtsbPayNo = selectedTr.prop("title").split("_")[3];
                        ...
                        MyLibraryJs.JqPluginExt.fnKendoWindowOpen(src,
                            {
                                title: "傳票瀏覽(會簽編號/核銷號)："+AtsbApplyWordNum+ "/"+  CtsbPayNo,
                                width: document.getElementsByTagName('body')[0].clientWidth * 0.95,
                                height: document.documentElement.offsetHeight * 0.85
                            });
                    } else {
