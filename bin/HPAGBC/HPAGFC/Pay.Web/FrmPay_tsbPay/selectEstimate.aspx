<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectEstimate.aspx.cs" Inherits="Pay.Web.FrmPay_tsbPay.selectEstimate" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox ID="txtTotaltsbEstimateMoney" runat="server" Style="display: none"></asp:TextBox>

            <div class="MainCon2" style="width: 90%">
                <h1 class="h1Class">
                    <asp:Label ID="lbltitle" runat="server" Text="沖抵估列選擇"></asp:Label>
                    <asp:CheckBox ID="chkPayOther" runat="server" Text="不同受款人" AutoPostBack="True"  OnCheckedChanged="chkPayOther_CheckedChanged"/>
                </h1>
                ...
                <div>
                    <asp:GridView ID="GridView1" runat="server" MyName="gvList" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="估列號" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblStsbEstimateNo" runat="server" Text='<%# Eval("StsbEstimateNo") %>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="日期" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblStsbEstimateDate" runat="server" Text='<%# string.Format("{0:d}" ,Eval("StsbEstimateDate")) %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Width="60" />
                                <ItemStyle HorizontalAlign="Center" Width="60" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="餘額" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblSAtsbEstimateMoney" runat="server" Text='<%# Eval("SBtsbEstimateMoney") %>' Style="display: none"></asp:Label><!----估列金額--->
                            ...
                            <asp:TemplateField HeaderText="本次沖抵金額" Visible="True">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtPayofftsbEstimateMoney" runat="server"></asp:TextBox>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Width="60" />
                                <ItemStyle HorizontalAlign="Center" Width="60" />
                            </asp:TemplateField>
