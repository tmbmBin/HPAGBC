<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCActVisa1.ascx.vb" Inherits="UI.TrlActProdApply.Web.UCActVisa1" %>
...
<table cellSpacing="1" cellPadding="1" width="600" border="0">
        ...
        <tr>
                ...
                <input id="savescrollpos" type="hidden" name="savescrollpos" runat="server">
													<%--<asp:datagrid id="DataGrid2" runat="server" Width="1200" AutoGenerateColumns="False">--%>
                                                        <%--20150826 [mdf]:隱藏控帳業務需修改寬度--%>
                                                    	<asp:datagrid id="DataGrid2" runat="server" Width="1060" AutoGenerateColumns="False">
														...
														<Columns>
                                                            ...
                                                            <asp:TemplateColumn>
                                                                <HeaderTemplate>
                                                                  <%--  <table  style="table-layout:fixed" border=0 cellpadding=0 cellspacing=0 width ="970px" >--%>
                                                                     <%--20150826 [mdf]:隱藏控帳業務需修改寬度--%>
                                                                       <table  style="table-layout:fixed" border=0 cellpadding=0 cellspacing=0 width ="830px" >
                                                                        <tr>
                                                                            ...
                                                                            <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 140px; COLOR: #ffffff; TEXT-ALIGN: center; display:none">控帳業務</td>
                                                                            ...
                                                                            <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 30px; COLOR: #ffffff; TEXT-ALIGN: center; display:none">暫付</td>
                                                                            <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 100px; COLOR: #ffffff; TEXT-ALIGN: center" >就地審計</td>
                                                                            <td style="BORDER-RIGHT: #ffffff 1px solid;FONT-SIZE: 10pt; WIDTH: 60px; COLOR: #ffffff; TEXT-ALIGN: center" >移除新增</td>
                                                                        </tr>
                                                                    </table>                                                                   
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                              <%--  <table style="table-layout:fixed;height:100%; margin-left:-5px" border=0 cellpadding=0 cellspacing=0 width ="1240" >--%>
                                                                           <%--20150826 [mdf]:隱藏承辦業務需修改寬度--%>
                                                                         <table style="table-layout:fixed;height:100%; margin-left:-5px" border=0 cellpadding=0 cellspacing=0 width ="1100" >
                                                                    <tr>
                                                                        <td>
                                                                           <%-- <table style="table-layout:fixed;height:100%; margin-left:-1px" border=0 cellpadding=0 cellspacing=0 width ="1110" >--%>
                                                                                  <%--20150826 [mdf]:隱藏承辦業務需修改寬度--%>
                                                                                  <table style="table-layout:fixed;height:100%; margin-left:-1px" border=0 cellpadding=0 cellspacing=0 width ="970" >
                                                                                <tr>
                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 30px; TEXT-ALIGN: center" valign=top><asp:TextBox ID="TBdgBgtMonth" runat="server" Width="30px" onfocus="this.blur();" Style=" text-align:center" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgBgtMonth" ></asp:TextBox></td>
                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 70px; TEXT-ALIGN: center" valign=top><asp:TextBox ID="TBdgAccKindName" runat="server" Width="70px" onfocus="this.blur();"  MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgAccKindName" ></asp:TextBox></td>
                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 120px; TEXT-ALIGN: center" valign=top><asp:TextBox ID="TBdgBgtSourName" runat="server" Width="120px" onfocus="this.blur();" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgBgtSourName" ></asp:TextBox></td>
                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 120px; TEXT-ALIGN: center" valign=top><asp:TextBox ID="TBdgAcvBgtDepName" runat="server" Width="120px" onfocus="this.blur();" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgAcvBgtDepName" ></asp:TextBox></td>
                                                                                   <%--20150826 [mdf]:隱藏控帳業務--%>
                                                                                   <%-- <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 140px; TEXT-ALIGN: center" valign=top><asp:TextBox ID="TBdgBizName" runat="server" Width="140px" onfocus="this.blur();"    MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgBizName" ></asp:TextBox></td>--%>
                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 140px; TEXT-ALIGN: center; display:none" valign=top><asp:TextBox ID="TBdgBizName" runat="server" Width="140px" onfocus="this.blur();"    MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgBizName" ></asp:TextBox></td>
                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 300px; TEXT-ALIGN: center" valign=top><asp:TextBox ID="TBdgPalnName" runat="server" Width="300px"  onfocus="this.blur();" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgPalnName"  ></asp:TextBox></td>
                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 200px; TEXT-ALIGN: center" valign=top><asp:TextBox ID="TBdgOulName" runat="server" Width="200px"  onfocus="this.blur();"  MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgOulName" ></asp:TextBox></td>
                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 100px; TEXT-ALIGN: center" valign=top><asp:TextBox ID="TBdgAcvMoney" runat="server"  Width="100px"  onfocus="this.blur();"  style="text-align:right" MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgAcvMoney"></asp:TextBox></td>
                                                                                    ...
                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 30px; TEXT-ALIGN: center; display:none " valign=top><asp:CheckBox ID="CBdgPrePayFlag" runat="server"  Enabled="false"  /></td>
                                                                                    <td style="  FONT-SIZE: 10pt; WIDTH: 100px; TEXT-ALIGN: left" valign="top"><asp:TextBox ID="TBdgInspect" runat="server" Width="100px"  onfocus="this.blur();"  MyIndex="<%# Container.ItemIndex  %>" MyName="TBdgInspect" ></asp:TextBox></td>
                                                                                    <td style="  FONT-SIZE: 10pt; WIDTH: 30px; TEXT-ALIGN: left" valign="top"></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td colspan=12>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                           <%-- <table style="table-layout:fixed;height:100%;MARGIN-left:-1px" border=0 cellpadding=0 cellspacing=0 width ="1110px" > --%>
                                                                                             <%--20150826 [mdf]:隱藏承辦業務需修改寬度--%>
                                                                                               <table style="table-layout:fixed;height:100%;MARGIN-left:-1px" border=0 cellpadding=0 cellspacing=0 width ="970px" > 
                                                                                                 <tr>
                                                                                                    ...
                                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 30px; TEXT-ALIGN: center; display:none" valign=top><asp:CheckBox ID="CBdlPrePayFlag" runat="server" /></td>
                                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 100px;  TEXT-ALIGN: center" valign=top><asp:DropDownList ID="DDLdlInspect"   runat="server"  Width="100px" MyName="DDLdgInspect" ></asp:DropDownList></td>
                                                                                                    <td style="BORDER-RIGHT: #ffffff 1px solid; FONT-SIZE: 10pt; WIDTH: 30px;  TEXT-ALIGN: center" valign=top><asp:CheckBox ID="CBDel" runat="server" ToolTip="移除本筆資料" /></td>
                                                                                                 </tr>
                                                                                            </table>
                                                                                        </ItemTemplate>
                                                                                        </asp:DataList>
                                                                        ...
                                                                        <td style="FONT-SIZE: 10pt; WIDTH: 20px; TEXT-ALIGN: right" valign=bottom ><asp:Button id=BtnSplit  runat="server" Text="+" CssClass="<%# Container.ItemIndex %>" MyName="BtnSplit" MyIndex="<%# Container.ItemIndex %>" OnClick="BtnSplit_Click"></asp:Button></td>
                                                                    </tr>
                                                                    </table>
                                                                </ItemTemplate>
