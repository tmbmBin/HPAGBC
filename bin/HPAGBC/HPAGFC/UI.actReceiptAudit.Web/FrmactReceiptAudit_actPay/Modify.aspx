<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="UI.actReceiptAudit.Web.FrmactReceiptAudit_actPay.Modify" %>
                ...
                <ItemTemplate>
                    <table class="MainCon3" style="width: 100%; vertical-align: top" border="1">
                        <tr>
                            ...
                            <td class="qury_table_td2">
                                <asp:Label ID="lblAcmMoney" runat="server" Text='<%# Eval("AcmMoney").ToMoney() %>'></asp:Label></td>
                            <%--<asp:TextBox ID="txttsbMoney" runat="server" Text='<%# Eval("tsbFee").ToMoney() %>'></asp:TextBox>--%>
                            </td>
                        </tr>
                        <tr>
                            <td class="qury_table_td">減列人員</td><%--核銷人員--%>
                            <td class="qury_table_td2">
                       ...
                       <%--         <asp:TextBox ID="txtAcpMoneyALL" runat="server" Text='<%# Eval("AcpMoneyALL") %>' Width="70%" ></asp:TextBox>--%>
                        ...
                        <tr>
                            ...
                            <td class="qury_table_td4" colspan="3">
                                <asp:TextBox ID="txtPayName" runat="server" Text='<%# Eval("PayName") %>' Width="70%" style="display:none"></asp:TextBox> <%-- 廠商名稱--%>
                                <asp:TextBox ID="txtMemo" runat="server" Text='<%# Eval("acmMemo") %>' Width="70%" Columns="20" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="qury_table_td4" colspan="3">
                                <asp:TextBox ID="txtSubMemo" runat="server" Text='<%# Eval("acmSubMemo") %>' Width="70%" Columns="20" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
