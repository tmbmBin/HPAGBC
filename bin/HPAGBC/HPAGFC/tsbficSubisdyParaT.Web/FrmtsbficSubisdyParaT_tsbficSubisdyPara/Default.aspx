<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="tsbficSubisdyParaT.Web.FrmtsbficSubisdyParaT_tsbficSubisdyPara.Default" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel ID="pnlSearch" runat="server" class="MainCon3">
                <h1 class="h1Class">補捐助參數設定作業資料查詢</h1>
                <table style="width: 100%">
                    ...
                    <tr>
                        <td class="qury_table_td">補捐助計畫</td>
                        <td class="qury_table_td2" colspan="3">
...
<%--                &nbsp;&nbsp;
            ...
            <div class="MainCon2">
                <h1 class="h1Class">補捐助參數設定作業資料明細</h1>
                ...
                <div>
                    <asp:GridView ID="GridView1" runat="server" MyName="gvList" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="補捐助計畫" Visible="True">
                                <ItemTemplate>
