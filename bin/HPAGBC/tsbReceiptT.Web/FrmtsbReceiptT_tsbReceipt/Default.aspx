            ...
            <asp:Panel ID="pnlSearch" runat="server" class="MainCon3">
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td class="qury_table_td2">
                            <asp:DropDownList ID="ddltsbWorkUnitNo" runat="server" AppendDataBoundItems="True" DataTextField="dptName" DataValueField="dptCode"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                ...
                <asp:UpdatePanel runat="server">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EnableViewState="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="預撥號" >
                                <ItemTemplate>
                                    <asp:Label ID="lbltsbPrePayNo" runat="server" Text='<%# Eval("tsbPrePayNo") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="核銷號" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lbltsbPayNo" runat="server" Text='<%# Eval("tsbPayNo") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Width="50" />
                                <ItemStyle HorizontalAlign="Center" Width="50" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="預撥餘額" >
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="繳回總額" >
                                <ItemTemplate>
